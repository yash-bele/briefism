...
export const technologyHistory = [
  ...
  // jan-21-2024
  {
    ...
    image:
      "/technology/jan-21-2024/palworld-the-pokemon-with-guns-game-achieves-over-3million-sales-in-just-40hours-post-launch.webp",
    title: `Palworld, the 'Pokemon with Guns' Game, Achieves Over 3 Million Sales in Just 40 Hours Post Launch`,
    preArticle: `The new open-world game Palworld, dubbed "Pokemon with guns", has sold
          3 million copies in just 40 hours since launching. The title has
          instantly become one of the most played and top-selling games
          globally.`,
    article: (
      <div className="space-y-6">
        <p>
          The new open-world game Palworld, dubbed &quot;Pokemon with
          guns&quot;, has sold 3 million copies in just 40 hours since
          launching. The title has instantly become one of the most played and
          top-selling games globally.
        </p>
        <p>
          In this role-playing game, players can shoot, kill and capture over
          100 Pokemon-like creatures called Pals using a Pokeball device. You
          can ride, enslave and arm your captured Pals, having them fight
          alongside you or battle other monsters. There are also boss Pals that
          are challenging to defeat but can be caught and enslaved.
        </p>
        <div>
          <blockquote className="twitter-tweet">
            <p lang="en" dir="ltr">
              <a href="https://twitter.com/hashtag/Palworld?src=hash&amp;ref_src=twsrc%5Etfw">
                #Palworld
              </a>{" "}
              has sold over 3 million copies in 40 hours since release! <br />
              <br />
              Thank you everyone for playing Palworld!
              <br />
              <br />
              We are so overwhelmed but also encouraged by this incredible
              accomplishment!
              <br />
              <br />
              Please leave a review if you’ve been enjoying your time in
              Palworld!
              <a href="https://twitter.com/hashtag/Pocketpair?src=hash&amp;ref_src=twsrc%5Etfw">
                #Pocketpair
              </a>{" "}
              <a href="https://t.co/NNI0D6a9On">pic.twitter.com/NNI0D6a9On</a>
            </p>
            &mdash; Palworld (@Palworld_EN){" "}
            <a href="https://twitter.com/Palworld_EN/status/1748871267439247623?ref_src=twsrc%5Etfw">
              January 21, 2024
            </a>
          </blockquote>
        ...
        <p>
          ...
          requiring teamwork to take on tough Pals and craft items to survive
          the harsh world. Gameplay involves base building like Minecraft, with
          the ability to loot other players&apos; bases and items.
        </p>
        <p>
          You can utilize enslaved Pals to construct bases, assign them tasks,
          force them to work, engage in farming, build houses and more. Each Pal
          has a distinct personality and food needs, suitable for different
          roles.
        </p>
        <p>
          Within just 8 hours of its early access launch on the popular Steam
          marketplace, Palworld sold over 1 million copies. Recently, some
          connectivity issues arose but developers quickly resolved them.
          Palworld has now surpassed Counter-Strike 2 as the game with the most
          concurrent players on the platform.
        </p>
        <p>
          In summary, the controversial new game Palworld, which allows
          capturing and exploiting Pokemon-like creatures, has seen immense
          immediate success, selling 3 million copies and becoming a top-played
          title globally shortly after launching. Its unique mix of
          Pokemon-style collection and open-world survival gameplay has
          resonated widely despite ethical concerns.
        </p>
      </div>
    ),
  },
  {
    id: "astrobiotic-peregrine-mission-faces-setback-while-japan-moon-sniper-achieves-successful-landing",
    timestamp: "Jan 21, 2024",
    image:
      "/technology/jan-21-2024/astrobiotic-peregrine-mission-faces-setback-while-japan-moon-sniper-achieves-successful-landing.webp",
    title: `Astrobiotic's Peregrine Mission Faces Setback, While Japan's Moon Sniper Achieves Successful Landing`,
    preArticle: `The Peregrine lunar lander mission by Pittsburgh-based Astrobiotic has
          ended unsuccessfully. On Friday morning, the company lost contact with
          the spacecraft, which likely burned up in the atmosphere, sealing the
          fate of a doomed endeavor that faltered soon after launch. However,
          later that day, Japan's "SLIM" moon mission did manage to land, though
          it is also facing issues.`,
    article: (
      <div className="space-y-6">
        <p>
          The Peregrine lunar lander mission by Pittsburgh-based Astrobiotic has
          ended unsuccessfully. On Friday morning, the company lost contact with
          the spacecraft, which likely burned up in the atmosphere, sealing the
          fate of a doomed endeavor that faltered soon after launch. However,
          later that day, Japan&apos;s &quot;SLIM&quot; moon mission did manage
          to land, though it is also facing issues.
        </p>
        <p>
          Peregrine&apos;s trajectory was set long before the loss of signal on
          Friday. It had launched on January 8th aboard the maiden flight of
          United Launch Alliance&apos;s Centaur rocket. The new Centaur rocket,
          a Boeing and Lockheed Martin joint venture, performed well. But
          shortly after Peregrine separated from the launch vehicle, it sprung a
          leak and spewed fuel.
        </p>
        <div>
          <blockquote className="twitter-tweet">
            <p lang="en" dir="ltr">
              (1/3) Final Update for Peregrine Mission One{" "}
              <a href="https://t.co/4NWeCpyLFh">pic.twitter.com/4NWeCpyLFh</a>
            </p>
            &mdash; Astrobotic (@astrobotic){" "}
            <a href="https://twitter.com/astrobotic/status/1748448183628218653?ref_src=twsrc%5Etfw">
              January 19, 2024
            </a>
          </blockquote>
          <script async src="https://platform.twitter.com/widgets.js" />
        ...
        <p>
          ...
          landing on the Moon since Apollo 17 in 1972. After detecting the fuel
          leak, Astrobiotic pivoted the mission to operate more like a
          satellite. They tested Peregrine&apos;s scientific instruments and
          systems as it flew thousands of kilometers before directing it to burn
          up in Earth&apos;s atmosphere.
        </p>
        <p>
          If successful, it would have been the first private soft lunar
          landing, following the Israeli Beresheet mission in 2019 and Japanese
          UTO mission in 2023 which did achieve crash landings on the surface.
          Unfortunately, Peregrine did not progress as far.
        </p>
        <p>
          On the same day as Peregrine&apos;s loss of signal, the Japan
          Aerospace Exploration Agency (JAXA) confirmed its Smart Lander for
          Investigating Moon (SLIM) successfully touched down, making Japan the
          fifth nation to accomplice a soft lunar landing after the U.S., Soviet
          Union, China and India.
        </p>
        <p>
          But the mission dubbed the “moon sniper” for its precision 100 meter
          landing capability has run into problems. The spacecraft&apos;s solar
          cells are not generating any power.
        </p>
        <p>
          JAXA attempted some life-sustaining measures like switching off
          SLIM&apos;s heater, but the battery can only endure for a few hours on
          the moon&apos;s surface. JAXA hopes a change in sunlight angle will
          energize the solar panels again.
        </p>
        <p>
          There have been several moon missions in the last two years - Japan’s
          SLIM and Hakuto, Russia’s Luna-25, India&apos;s Chandrayaan-3,
          Peregrine and more, with varying outcomes.
        </p>
        <p>
          This emphasizes the new space race and push to establish a sustained
          lunar presence. Once we have a moon base, it can propel missions
          deeper into space. While that future is distant, space technology has
          already benefited daily life with smartphone cameras, memory foam
          mattresses and more.
        </p>
        <p>
          Now, advancements may enable connecting directly to satellite networks
          using just smartphones, without specialized hardware like satellite
          terminals or phones.
        </p>
        <p>
          Google, AT&T and Vodafone have invested over $155 million in AST
          SpaceMobile to develop direct-to-device satellite connectivity. In
          2023, the company demonstrated 2G, 4G and 5G calls and 14 Mbps
          downloads directly from a satellite to regular smartphones using those
          companies&apos; networks.
        </p>
        <p>
          Google will collaborate on product development, testing and
          implementation to enable SpaceMobile connectivity for Android devices.
        </p>
        <p>
          So while the two recent moon missions had different fates, the
          constant push to explore space will continue advancing technology that
          improves life on Earth too. Focus on the cosmos beyond will lead to
          innovations that enrich our world.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    image:
      "/week-jan-02-2024/technology/redmi-note-13-pro-a-brief-yet-promising-review.webp",
    title: `Redmi Note 13 Pro+: A Brief Yet Promising Review`,
    preArticle: `Xiaomi has started releasing phones as of late 2024. A few weeks after
        its launch in China, the Redmi Note 13 series is now available
        everywhere.`,
    article: (
      <>
        Xiaomi has started releasing phones as of late 2024. A few weeks after
        its launch in China, the Redmi Note 13 series is now available
        everywhere. It appears that the company is eager to get its newest
        mid-range 5G phone in front of customers who are willing to pay less
        than Rs 35,000 for a phone. I had the opportunity to test-drive the
        Redmi Note 13 Pro+ beforehand, and this is my brief assessment of it.
        <br />
        <br />
        <br />
        <div className="space-y-1.5">
          <span className="text-xl">
            User&apos;s Swift Take on Redmi Note 13 Pro+
          </span>
          <div className="flex flex-col space-y-3">
            <span>
              The Redmi Note 13 Pro+&apos;s design is impressive, and I like
              that Xiaomi releases new models every time a new one comes out.
              Some companies in the market have been offering their signature
              design on the majority of their products because it helps them
              save money and improve brand recognition. Still, companies like
              Xiaomi constantly tweak their designs with a strong focus on
              aesthetics in an effort to win over customers.
            </span>
            <span>
              The glass body and metal frames of the Redmi Note 13 Pro+ give it
              a wonderful feel in the hand. After glancing at it, a few people
              even asked me which phone it was. Although there is a leather
              finish option that may provide a better grip on the device, the
              glass back panel is indeed a little slick. There is a coating on
              the back&apos;s upper side that functions somewhat like a mirror.
              In other words, the subject of your photo will have some idea of
              how you are posing them.
            </span>
            <span>
              Additionally, the gadget is not heavy at all, and I had no trouble
              using it with one hand. The Redmi Note 13 Pro+&apos;s button
              placement is ideal for me, and people who enjoy large, bright
              displays will find it enjoyable to use. Because of the
              device&apos;s slightly curved edges and thin bezels surrounding
              the screen, the display appears larger. The vibrant colors are
              appealing, and I appreciate that Xiaomi used premium Gorilla Glass
              Victus for increased durability. Additionally, at a lower price
              point, there is support for an IP68 water-resistant rating,
              something we have started to see on a few phones. The fact that
              the gadget won&apos;t be harmed during the wet season is
              fantastic.
            </span>
            <span>
              Because of the MediaTek Dimensity 7200-Ultra chipset, the Redmi
              Note 13 Pro+ felt incredibly smooth during the short time I had it
              in use. At the default settings, games such as Genshin Impact
              operated smoothly. As I continue to test it, we will discuss the
              performance aspect in our in-depth analysis. It&apos;s also true
              that the speakers sounded excellent. Dolby Atmos audio is only
              compatible with certain services, such as the Apple Music app.
            </span>
            <span>
              The software of the Redmi Note 13 Pro+ enhances the seamless
              performance as well. In place of the MIUI custom skin, the device
              comes with HyperOS, which is cleaner and less cluttered than what
              we have seen on previous models. The notification panel resembles
              that of iOS as well, but the user interface (UI) appears to be
              more user-friendly and fluid, and experience is what really
              counts.
            </span>
            <span>
              It&apos;s crucial to remember that HyperOS, according to Xiaomi,
              is a lightweight system made to facilitate seamless connections
              between Xiaomi users and their personal devices, automobiles, and
              smart home appliances rather than a redesigned version of MIUI.
              Basically, it&apos;s to create a single, integrated system out of
              all Xiaomi devices.
            </span>
            <span>
              We are unable to comment much about the smartphone&apos;s camera
              performance at this time because we are still testing it. All I
              can say is that the 200-megapixel camera mode can capture some
              excellent detailed photos, and the performance appears promising.
            </span>
            <span>
              With a 5,000mAh unit under the hood, long battery life is
              anticipated. The fast charger that Xiaomi is including in the
              package is a plus. We will verify the 120W charger&apos;s stated
              ability to fully charge a battery from empty to 100% in roughly 19
              minutes, as stated by the manufacturer.
            </span>
          </div>
        </div>
        <br />
        ...
        <div className="flex flex-col space-y-1.5">
          <span className="text-xl">Final Verdict on Redmi Note 13 Pro+</span>
          <span>
            With its features, the Redmi Note 13 Pro+ appears to be a good
            all-around package and a promising device. Some fans of the Redmi
            Note series might find it difficult to accept that the company has
            produced a device that costs more than Rs 30,000 now that they have
            released the new version. Redmi has, however, also made sure that
            its new mid-range phone is powerful. With the Redmi Note 13 Pro+,
            you get almost all of the features you could anticipate from a
            device in its price range. All that remains to be seen is if this
            translates into effective performance in the practical setting. The
            device is expected to face competition from well-known phones under
            Rs 35,000, such as the OnePlus Nord 3 and iQOO Neo 7 Pro. The
            in-depth analysis of the most recent Redmi phone will be released
            soon, so be sure to check back with India Today Tech.
          </span>
        </div>
      </>
    ),
