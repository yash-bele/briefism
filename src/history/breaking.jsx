...
`,
  ...
  {
    id: "white-house-alarmed-by-spurious-online-taylor-swift-images",
    timestamp: "Jan 27, 2024",
    image: `/breaking/jan-27-2024/white-house-alarmed-by-spurious-online-taylor-swift-images.webp`,
    title: `White House Alarmed by Spurious Online Taylor Swift Images`,
    preArticle: `On Friday, the White House expressed deep concern over the proliferation of counterfeit online images featuring pop sensation Taylor Swift. The administration underscored the crucial role social media platforms must assume in upholding their rules to curb the dissemination of such misleading content`,
    article: (
      <div className="space-y-6">
        <p>
          On Friday, the White House expressed deep concern over the
          proliferation of counterfeit online images featuring pop sensation
          Taylor Swift. The administration underscored the crucial role social
          media platforms must assume in upholding their rules to curb the
          dissemination of such misleading content.
        </p>
        <p>
          Throughout the week, fabricated sexually explicit images of Swift
          inundated various social media channels. Notably, one such image
          circulated on X, formerly known as Twitter, garnered a staggering 47
          million views before the account responsible was suspended, as
          reported by The New York Times.
        </p>
        <p>
          Addressing the issue at a press briefing, White House Press Secretary
          Karine Jean-Pierre emphasized the gravity of the situation. She
          pledged proactive measures to address the alarming trend and advocated
          for legislative action by Congress to tackle the matter
          comprehensively.
        </p>
        <p>
          Highlighting the lax enforcement against misleading images,
          Jean-Pierre raised the possibility that artificial intelligence (AI)
          could be behind the creation of such content. She underscored the
          disproportionate impact on women, noting that these incidents are all
          too common.
        </p>
        <p>
          While acknowledging the autonomy of social media companies in managing
          content, Jean-Pierre asserted the administration&apos;s belief in
          their pivotal role in enforcing regulations. Specifically, she urged
          these platforms to take robust actions to prevent the dissemination of
          misinformation and non-consensual, intimate imagery involving real
          individuals.
        </p>
      </div>
    ),
  ...
  {
    id: "two-fatalities-in-noida-as-family-uses-gas-room-heater-while-sleeping",
    timestamp: "Jan 27, 2024",
    image: `/breaking/jan-27-2024/two-fatalities-in-noida-as-family-uses-gas-room-heater-while-sleeping.jpg`,
    title: `Two Fatalities in Noida as Family Uses Gas Room Heater While Sleeping`,
    preArticle: `Tragedy struck in the Chhijarasi colony of Sector-63 police station area in Noida, where two family members, including a three-month-old infant, lost their lives allegedly due to suffocation caused by a gas room heater left on overnight, as reported by the police on Friday. The victims, identified a`,
    article: (
      <div className="space-y-6">
        <p>
          Tragedy struck in the Chhijarasi colony of Sector-63 police station
          area in Noida, where two family members, including a three-month-old
          infant, lost their lives allegedly due to suffocation caused by a gas
          room heater left on overnight, as reported by the police on Friday.
          The victims, identified as 35-year-old Sammu Khan and his infant
          daughter, are believed to have inhaled toxic smoke emitted by the
          heater.
        </p>
        <p>
          According to preliminary investigations, the family had slept with the
          gas room heater on amid cold weather conditions. The police
          spokesperson stated, &quot;The man and his daughter died due to
          suffocation caused by the heater. The deceased bodies have been sent
          for postmortem, and further legal action is underway.&quot;
        </p>
        <p>
          Sammu Khan, originally from Pilibhit district in Uttar Pradesh, had
          been residing in Noida on rent with his wife, Ujma, and their
          three-month-old daughter. Sammu worked as a tailor to make ends meet.
        </p>
        <p>
          As the tragic incident unfolded, Ujma Khan was rushed to SJM Hospital
          in Noida. Medical professionals have described her condition as
          critical, and she is currently on a ventilator, receiving intensive
          care. Authorities are actively pursuing legal measures to address the
          situation.
        </p>
      </div>
    ),
  ...
  {
    id: "bharat-ratna-to-karpoori-thakur-bjps-appropriation-of-the-social-justice-agenda",
    timestamp: "Jan 27, 2024",
    image: `/breaking/jan-27-2024/bharat-ratna-to-karpoori-thakur-bjps-appropriation-of-the-social-justice-agenda.jpg`,
    title: `Bharat Ratna to Karpoori Thakur: BJP's Appropriation of the Social Justice Agenda`,
    preArticle: `The timing of the Union government's announcement conferring Bharat Ratna on the late Karpoori Thakur, a day after the Ayodhya temple inauguration, may appear coincidental. However, with Thakur's centenary falling on January 24 and the customary national awards announcement preceding Republic Day, t`,
    article: (
      <div className="space-y-6">
        <p>
          The timing of the Union government&apos;s announcement conferring
          Bharat Ratna on the late Karpoori Thakur, a day after the Ayodhya
          temple inauguration, may appear coincidental. However, with
          Thakur&apos;s centenary falling on January 24 and the customary
          national awards announcement preceding Republic Day, the convergence
          of events prompts scrutiny in the lead-up to the impending Lok Sabha
          elections.
        </p>
        <p>
          The overarching question arises: Can the Hindutva agenda secure
          victory by assimilating the social justice agenda? In essence, can the
          drive to construct and weaponize a unified Hindu identity overcome the
          ingrained hierarchies of Hindu caste divisions?
        </p>
        <p>
          This query gains significance in light of the fact that the current
          influence of the Hindutva agenda hinges on state power. The pursuit of
          electoral majorities through elections remains the primary avenue to
          secure and legitimize this power. Traditionally, the Hindu
          &quot;upper&quot; castes have constituted the core constituency for
          Hindutva, but given their status as a demographic minority, the
          numerical support of the so-called lower-caste Hindus is crucial for
          electoral success.
        </p>
        <p>
          The strategic move to confer Bharat Ratna on Thakur holds symbolic
          value, aligning with the ideological legacy of leaders like Nitish
          Kumar and Lalu Prasad. Thakur&apos;s political influence played a
          pivotal role in their rise to power, emphasizing the BJP&apos;s
          representation of backward castes without making substantial
          concessions.
        </p>
        <p>
          A closer look at Thakur&apos;s political agenda in the 1970s reveals a
          stark contrast with the current BJP narrative. Thakur pursued a
          popular-leftist caste agenda aimed at breaking the monopoly of the
          upper castes in Bihar. In contrast, the BJP attempts to recruit
          various castes to support an essentially upper-caste political
          program, camouflaging it as a populist initiative for electoral gain.
        </p>
        <p>
          Another divergence lies in Thakur&apos;s stance on the official
          language, aligning with a multilingual approach to promote Indian
          languages and national integration. This stands in contrast to the
          BJP&apos;s emphasis on Hindi and its reluctance to accommodate
          linguistic diversity.
        </p>
        <p>
          In summary, Thakur&apos;s Bharat Ratna serves the BJP&apos;s interests
          by appropriating ideological capital without aligning with
          Thakur&apos;s original leftist caste agenda. If a Bharat Ratna were to
          be awarded for the advancement of backward castes, Devaraj Urs, with
          his development-centric social justice agenda, could be a more fitting
          candidate. Urs, as the chief minister of Karnataka in the 1970s,
          forged alliances across communities without promoting communal hatred,
          making his contribution to social justice more substantial.
        </p>
      </div>
    ),
  },
  // jan-26-2024
  {
    id: "why-has-the-united-states-opted-for-nitrogen-gas-execution-over-lethal-injection",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/why-has-the-united-states-opted-for-nitrogen-gas-execution-over-lethal-injection.webp`,
    title: `Why has the United States opted for Nitrogen gas execution over lethal injection?`,
    preArticle: `Kenneth Smith, a convicted murderer, has become the inaugural individual in the United States to undergo execution by nitrogen gas, employing a contentious new method that some experts caution could result in severe suffering or even torture. Smith, previously on death row for his participation in `,
    article: (
      <div className="space-y-6">
        <p>
          Kenneth Smith, a convicted murderer, has become the inaugural
          individual in the United States to undergo execution by nitrogen gas,
          employing a contentious new method that some experts caution could
          result in severe suffering or even torture.
        </p>
        <p>
          Smith, previously on death row for his participation in a 1988
          murder-for-hire plot that claimed the life of Elizabeth Sennett, had
          narrowly escaped lethal injection in 2022. During that attempt, his
          execution was halted when prison staff failed to successfully insert
          two intravenous lines into his veins, a requirement under the
          protocol, managing only to insert one line after an hour of attempts.
        </p>
        <p>
          Now, Smith faced a different fate: death through exposure to nitrogen
          gas. He was affixed to a mask that delivered pure nitrogen gas for a
          period of up to 15 minutes, cutting off the oxygen supply to his
          brain, leading to unconsciousness and eventual death.
        </p>
        <p>
          This method represents an alternative chosen by some states due to the
          challenges associated with lethal injection, the most prevalent
          execution method in the US.
        </p>
        <p>
          While around half of the US states still retain the death penalty,
          they employ various methods such as hanging, firing squad, or the
          electric chair. However, none of these methods have been declared
          unconstitutional by the US Supreme Court, although some state courts
          have prohibited specific techniques.
        </p>
        <p>
          Lethal injection, introduced in Texas in 1982, has been the preferred
          method, yet it has encountered numerous issues, both practical and
          ethical. Several executions have been mishandled, causing pain and
          suffering to the inmates. Some, like Smith, have faced delays or
          cancellations due to difficulties in locating suitable veins.
          Additionally, certain states have encountered challenges in obtaining
          the necessary drugs for lethal injection, as drug manufacturers refuse
          to sell them for such purposes.
        </p>
        <p>
          Since 2011, both the UK and the EU have prohibited the export of
          lethal injection drugs, and Pfizer, a major supplier, ceased providing
          them for execution purposes in 2016. Consequently, some states have
          turned to untested or undisclosed drugs from private sources,
          including compounding pharmacies.
        </p>
        <p>
          Nitrogen gas has emerged as another option explored by some states.
          Alabama, along with Oklahoma and Mississippi, has sanctioned the use
          of nitrogen gas in executions and defended it against legal
          challenges. Advocates argue that nitrogen gas provides a humane and
          painless method, inducing a state of euphoria and unawareness before
          death. They cite examples of industrial accidents where workers died
          of nitrogen hypoxia without realizing it.
        </p>
        <p>
          However, critics of nitrogen gas contend that it is an experimental
          and unproven method that could inflict harm and suffering on the
          inmates.
        </p>
        <p>
          Dr. Jeff Keller, President of the American College of Correctional
          Physicians, remarked, “It’s an experimental procedure. Many things can
          go wrong.”
        </p>
        <p>
          Deborah Denno, a criminologist at Fordham Law School specializing in
          death penalty methods, emphasized, “The procedure is supposed to be
          painless. But I have to emphasize - that’s in theory.” She pointed out
          that the masks used for nitrogen gas may not fit properly, potentially
          allowing air to leak in, and warned of potential complications such as
          vomiting or survival with brain damage.
        </p>
      </div>
    ),
  },
  {
    id: "arizona-state-university-partners-with-open-ai-to-extend-ai-presence-in-higher-education",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/arizona-state-university-partners-with-open-ai-to-extend-ai-presence-in-higher-education.webp`,
    title: `Arizona State University partners with OpenAI to extend AI presence in higher education`,
    preArticle: `Arizona State University (ASU) has joined forces with OpenAI to introduce the advanced capabilities of ChatGPT Enterprise into higher education. This collaboration aims to establish a new standard for how universities can enrich learning experiences, foster creativity, and improve student outcomes u`,
    article: (
      <div className="space-y-6">
        <p>
          Arizona State University (ASU) has joined forces with OpenAI to
          introduce the advanced capabilities of ChatGPT Enterprise into higher
          education. This collaboration aims to establish a new standard for how
          universities can enrich learning experiences, foster creativity, and
          improve student outcomes using state-of-the-art AI technology.
        </p>
        <p>
          ChatGPT, developed by OpenAI, has seen increased adoption by
          organizations since its introduction a year ago. Now, ASU is
          integrating ChatGPT into its educational programs to explore
          innovative applications and contribute to the responsible evolution of
          AI learning technologies.
        </p>
        <p>
          ASU President Michael M. Crow emphasized the university&apos;s
          commitment to actively participating in the responsible development of
          AI learning technologies. The collaboration aims to prioritize user
          privacy by implementing robust security measures, ensuring the
          protection of user data against digital threats.
        </p>
        <p>
          According to Brad Lightcap, Chief Operating Officer at OpenAI,
          ASU&apos;s integration of ChatGPT into educational programs
          demonstrates the university&apos;s leadership in innovation,
          leveraging AI to enhance the learning experience.
        </p>
        <p>
          Beginning February 2024, ASU will invite submissions from faculty and
          staff to propose innovative uses of ChatGPT Enterprise. The focus
          areas for these proposals include enhancing student success, exploring
          new avenues for innovative research, and streamlining organizational
          processes. This collaboration signifies a significant step toward
          integrating advanced AI capabilities into higher education, marking a
          milestone in the evolution of learning technologies.
        </p>
      </div>
    ),
  },
  {
    id: "australias-cyclone-kirrily-power-outages-affect-thousands-during-intense-rainfall",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/australias-cyclone-kirrily-power-outages-affect-thousands-during-intense-rainfall.avif`,
    title: `Australia's Cyclone Kirrily: Power Outages Affect Thousands During Intense Rainfall`,
    preArticle: `Overnight, a tropical cyclone named Kirrily struck Queensland, Australia, leaving tens of thousands of residents without power due to damaging winds and heavy rainfall. The cyclone, initially categorized as a level two system, made landfall near the tourist town of Townsville along the Great Barrier`,
    article: (
      <div className="space-y-6">
        <p>
          Overnight, a tropical cyclone named Kirrily struck Queensland,
          Australia, leaving tens of thousands of residents without power due to
          damaging winds and heavy rainfall. The cyclone, initially categorized
          as a level two system, made landfall near the tourist town of
          Townsville along the Great Barrier Reef coast on Thursday before being
          downgraded to a tropical low on Friday.
        </p>
        <p>
          Australia is currently experiencing an El Niño weather event, commonly
          associated with extreme weather phenomena like cyclones, wildfires,
          droughts, and heatwaves. Queensland Premier Steven Miles reported that
          approximately 64,000 people were facing power outages on Friday due to
          the cyclone. Most of the affected areas were in Townsville, and as of
          now, it is uncertain when power will be fully restored.
        </p>
        <p>
          A category two cyclone is considered three levels below the most
          severe category, but it still has the potential to cause substantial
          damage, including to trees, caravans, crops, and boats. The Australian
          weather forecaster indicated that the former cyclone could bring heavy
          rain and possible damaging winds to northern parts of Queensland on
          Friday, with peak gusts around 90 km per hour (55 mph) expected.
        </p>
        <p>
          Premier Miles emphasized the high risk of flooding, stating that there
          is still a significant amount of rainfall expected. Prime Minister
          Anthony Albanese mentioned that military personnel are on standby to
          assist with cleanup efforts following Cyclone Kirrily. He acknowledged
          that the residents of far north Queensland have already faced
          challenging conditions in recent times.
        </p>
        <p>
          Cyclone Kirrily is the second tropical cyclone to impact the region
          since December, following Cyclone Jasper, which caused widespread
          damage in the area. Additionally, parts of Queensland and its southern
          neighbor, New South Wales, are on high alert for a heatwave, with
          temperatures expected to reach the high forties Celsius in some
          regional areas. In Sydney, the capital of New South Wales,
          temperatures in the west were forecasted to reach 40 degrees Celsius
          (104 degrees Fahrenheit), more than nine degrees above the average
          maximum for January.
        </p>
      </div>
    ),
  ...
  {
    id: "france-aims-to-host-30000-indian-students-by-2030-announces-president-macron-on-75th-republic-day",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/france-aims-to-host-30000-indian-students-by-2030-announces-president-macron-on-75th-republic-day.webp`,
    title: `France aims to host 30,000 Indian students by 2030, announces President Macron on 75th Republic Day`,
    preArticle: `Before India's 75th Republic Day celebrations, President Emmanuel Macron of France unveiled plans to welcome approximately 30,000 Indian students to study in France. The announcement follows Prime Minister Narendra Modi's visit to Paris last year as the chief guest of France's National Day. In a po`,
    article: (
      <div className="space-y-6">
        <p>
          Before India&apos;s 75th Republic Day celebrations, President Emmanuel
          Macron of France unveiled plans to welcome approximately 30,000 Indian
          students to study in France. The announcement follows Prime Minister
          Narendra Modi&apos;s visit to Paris last year as the chief guest of
          France&apos;s National Day.
        </p>
        <p>
          In a post on X (formerly Twitter), the French president outlined the
          ambitious goal of hosting 30,000 Indian students in France by 2030.
          Macron expressed his determination to achieve this target and provided
          details on the initiatives to facilitate the process.
        </p>
        <div>
          <blockquote className="twitter-tweet">
            <p lang="en" dir="ltr">
              ...
              <br />
              <br />
              It’s a very ambitious target, but I am determined to make it
              happen.
              <br />
              <br />
              Here’s how:{" "}
              <a href="https://t.co/QDpOl4ujWb">pic.twitter.com/QDpOl4ujWb</a>
            </p>
            &mdash; Emmanuel Macron (@EmmanuelMacron){" "}
            <a href="https://twitter.com/EmmanuelMacron/status/1750705399550902544?ref_src=twsrc%5Etfw">
              January 26, 2024
            </a>
          </blockquote>{" "}
          <script
        ...
        <p>
          Macron highlighted the establishment of new centers with a network of
          Alliances françaises and international classes in France to promote
          French language learning. Additionally, he emphasized the
          simplification of the visa process for Indian alumni who have studied
          in the country.
        </p>
        <p>
          &quot;Coming to France means looking for excellence. We are launching
          new pathways to learn French in public schools with &apos;French for
          All, French for a Better Future.&apos; We are developing the network
          of Alliances françaises, with new centers for French learning. We are
          creating international classes that allow students, who may not speak
          French, to join our universities. Last but not least, we will
          facilitate the visa process for any former Indian students who studied
          in France,&quot; he explained.
        </p>
        <p>
          Macron proudly mentioned that France has 35 universities in the QS
          ranking, with about 15 in the Times Higher Education ranking. He
          highlighted the potential for collaboration between India and France,
          expressing the importance of achieving this through exchange and
          cooperation with the younger generation.
        </p>
        <p>
          &quot;We now have 35 universities in the QS ranking and about 15 in
          the Times Higher Education ranking. India and France have so much to
          do together, now and in the future. We will achieve this with you, our
          young people, in exchange and cooperation, in trust, in
          friendship!&quot; he added.
        </p>
        <p>
          In September 2023, following the announcement, the French embassy in
          India implemented several measures, including a five-year short-stay
          Schengen visa, to attract more Indian students. These initiatives are
          part of the people-to-people ties envisioned as one of the three
          pillars of the strategic partnership between the two countries.
        </p>
        <p>
          In another post, Macron, who is also the chief guest for the 75th
          Republic Day celebrations in India, extended warm wishes to Prime
          Minister Narendra Modi and the Indian people on Republic Day. &quot;My
          dear friend @NarendraModi, Indian people, My warmest wishes on your
          Republic Day. Happy and proud to be with you. Let’s celebrate!&quot;
        </p>
        <div>
          <blockquote className="twitter-tweet">
            <p lang="en" dir="ltr">
              ...
              <br />
              <br />
              My warmest wishes on your Republic Day. Happy and proud to be with
              you.
              <br />
              <br />
              Let’s celebrate!{" "}
              <a href="https://t.co/e5kg1PEc0p">pic.twitter.com/e5kg1PEc0p</a>
            </p>
            &mdash; Emmanuel Macron (@EmmanuelMacron){" "}
            <a href="https://twitter.com/EmmanuelMacron/status/1750708312004288962?ref_src=twsrc%5Etfw">
              January 26, 2024
            </a>
          </blockquote>{" "}
          <script
        ...
        <p>
          The Republic Day celebrations in India, led by President Droupadi
          Murmu, commemorate the nation&apos;s journey during the &apos;Amrit
          Kaal&apos; post the &apos;Azadi Ka Amrit Mahotsav,&apos; marking 75
          years of independence. The parade showcases India&apos;s rich cultural
          diversity, &apos;Aatmanirbhar&apos; military prowess, and the growing
          Nari Shakti. The event features the participation of around 13,000
          special guests, promoting Jan Bhagidari (people&apos;s participation)
  ...
  {
    id: "separated-at-birth-reunited-after-19-years-remarkable-journey-of-twins-rediscovering-each-other",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/separated-at-birth-reunited-after-19-years-remarkable-journey-of-twins-rediscovering-each-other.avif`,
    title: `Separated at Birth, Reunited After 19 Years: The Remarkable Journey of Twins Rediscovering Each Other`,
    preArticle: `Separated at birth, identical twins Amy Khvitia and Ano Sartania embarked on a remarkable journey of rediscovery, overcoming a childhood marred by abduction and deceit. Their heartwarming reunion, prompted by a TV talent show and a TikTok video, sheds light on a broader issue in Georgia, where thous`,
    article: (
      <div className="space-y-6">
        <p>
          Separated at birth, identical twins Amy Khvitia and Ano Sartania
          embarked on a remarkable journey of rediscovery, overcoming a
          childhood marred by abduction and deceit. Their heartwarming reunion,
          prompted by a TV talent show and a TikTok video, sheds light on a
          broader issue in Georgia, where thousands of infants have been
          abducted from hospitals and sold, with cases reported as recently as
          2005.
        </p>
        <p>
          Amy Khvitia and Ano Sartania, who were taken from their mother
          immediately after birth and sold to different families, eventually met
          their birth mother during their quest for answers, bridging the gap in
          their fragmented history.
        </p>
        <p>
          The narrative unfolds when the twins were 12 years old. Amy Khvitia,
          watching Georgia&apos;s Got Talent at her godmother&apos;s house near
          the Black Sea, was astonished to see a girl performing the jive who
          looked identical to her. Rumors circulated, with people questioning
          why Amy was dancing under a different name, but her mother dismissed
          it, attributing it to everyone having a doppelganger.
        </p>
        <p>
          Fast forward to November 2021, Amy Khvitia posted a TikTok video
          featuring her blue hair and a pierced eyebrow. The video, sent to Ano
          Sartania by a friend who recognized the striking resemblance, marked a
          pivotal moment in their journey. Ano Sartania attempted to find the
          girl, sharing the video on a university WhatsApp group, leading to a
          connection through Facebook when someone familiar with Amy Khvitia saw
          the message.
        </p>
        <p>
          Upon messaging each other, Amy Khvitia expressed, &quot;I have been
          looking for you for so long!&quot; Ano Sartania reciprocated, &quot;Me
          too.&quot; The realization dawned that both were born in Kirtskhi
          maternity hospital, which no longer exists, and their birth
          certificates indicated birthdays a few weeks apart, seemingly ruling
          out the possibility of being sisters, let alone twins.
        </p>
        <p>
          The unraveling mystery strengthened their bond. Amy Khvitia remarked,
          &quot;Every time I learned something new about Ano, things got
          stranger,&quot; emphasizing the uncanny similarities. Their meeting
          was an emotional mirror reflection – &quot;It was like looking in a
          mirror, the exact same face, exact same voice. I am her and she is
          me,&quot; said Amy Khvitia, while Ano Sartania expressed the
          significance of their connection through a hug, despite her usual
          aversion to them.
        </p>
        <p>
          Confronting their adoptive families, the twins discovered the shocking
          truth – they had been adopted separately, a few weeks apart, in 2002.
          Ano Sartania, though initially upset with her family, aimed to
          conclude the challenging conversations to facilitate collective
          healing. The birth mother, who they later located, revealed that she
          fell into a coma due to illness after childbirth. Hospital staff
          falsely informed her that the infants had died shortly after birth,
          perpetuating the deception that ultimately led to the twins&apos;
          separation.
        </p>
        <p>
          In summary, Amy Khvitia and Ano Sartania&apos;s journey is a poignant
          tale of resilience, reunion, and the enduring bond between siblings
          separated by deception. The power of social media, TV shows, and their
          unwavering determination brought them together, highlighting the
          broader issue of infant abductions and trafficking in Georgia.
        </p>
      </div>
    ),
  },
  {
    id: "chronology-of-the-gyanvapi-case",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/chronology-of-the-gyanvapi-case.avif`,
    title: `Chronology of the Gyanvapi Case`,
    preArticle: `Advocate Vishnu Shankar Jain, representing the Hindu party in the Gyanvapi dispute, highlighted the Archaeological Survey of India's acknowledgment that a significant Hindu temple existed before the current structure was erected. On May 16, 2022, a commission appointed by a local court concluded a `,
    article: (
      <div className="space-y-6">
        <p>
          Advocate Vishnu Shankar Jain, representing the Hindu party in the
          Gyanvapi dispute, highlighted the Archaeological Survey of
          India&apos;s acknowledgment that a significant Hindu temple existed
          before the current structure was erected.
        </p>
        <p>
          On May 16, 2022, a commission appointed by a local court concluded a
          videographic survey of the Kashi Vishwanath temple-Gyanvapi mosque.
          During the survey, a structure, contested as a &quot;shivling&quot; by
          the Hindu side and a &quot;fountain&quot; by the Muslim side, was
          discovered within the mosque premises.
        </p>
        <p>
          By July 21, 2023, the Varanasi district court ordered a scientific
          survey of the Gyanvapi mosque complex to determine whether it was
          &quot;constructed over a pre-existing structure of a Hindu
          temple.&quot; District and Sessions Judge A K Vishvesha directed the
          Archaeological Survey of India (ASI) to conduct a thorough
          investigation at the property in question, which is settlement plot
          number 9130 (Gyanvapi mosque).
        </p>
        <p>
          The ASI&apos;s survey, initially halted by legal challenges from the
          Anjuman Intezamia Masajid Committee for Gyanvapi mosque and the UP
          Sunni Central Waqf Board, resumed on August 4, 2023. The Allahabad
          High Court and the Supreme Court had dismissed pleas against the
          survey. Since then, the ASI teams have been diligently examining the
          campus.
        </p>
        <p>
          On December 11, 2023, the Varanasi district court granted an
          additional week to the ASI to present the findings of the
          court-mandated scientific survey of the Gyanvapi mosque premises.
        </p>
        <p>
          The latest development occurred on January 25, 2024, when the ASI
          submitted its report to both the Hindu and Muslim parties involved in
          the dispute.
        </p>
      </div>
    ),
  ...
  {
    id: "undeterred-by-police-notice-jarange-patil-persists-with-quota-march-in-mumbai",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/undeterred-by-police-notice-jarange-patil-persists-with-quota-march-in-mumbai.avif`,
    title: `Undeterred by Police Notice, Jarange Patil Persists with Quota March in Mumbai`,
    preArticle: `Despite the Mumbai Police issuing a notice denying permission for a hunger strike in the city, Maratha quota activist Manoj Jarange Patil has declared his intent to proceed with the demonstration at Azad Maidan on January 26. As thousands of Maratha protesters join him on their way to Vashi Agricult`,
    article: (
      <div className="space-y-6">
        <p>
          Despite the Mumbai Police issuing a notice denying permission for a
          hunger strike in the city, Maratha quota activist Manoj Jarange Patil
          has declared his intent to proceed with the demonstration at Azad
          Maidan on January 26. As thousands of Maratha protesters join him on
          their way to Vashi Agriculture Produce Market Committee (APMC),
          Jarange-Patil faced delays due to a massive crowd at his roadshow.
        </p>
        <p>
          Scheduled to begin his hunger strike with supporters at Azad Maidan,
          Jarange-Patil and his followers are advocating for Kunbi (OBC) status
          for the Maratha community. In response, the Mumbai Police issued a
          notice under Section 149 of the Criminal Procedure Code, expressing
          concerns about the potential disruption to Mumbai&apos;s financial
          operations and transportation system if the protesters entered the
          city.
        </p>
        <p>
          The police suggested an alternative gathering site at the
          International Corporation Park Ground in Kharghar, Navi Mumbai,
          emphasizing compliance with court orders. The notice highlighted
          restrictions on the size of protests at Azad Maidan and Shivaji Park
          due to space limitations and ongoing government events.
        </p>
        <p>
          Despite the police notice, Jarange Patil affirmed his commitment to
          Azad Maidan, expressing unawareness of any denial of permission. He
          asserted that the protest aims to secure Kunbi status for Marathas
          without disrupting Republic Day celebrations. The organizers in Mumbai
          announced plans for a flag-hoisting ceremony at Azad Maidan to mark
          Republic Day.
        </p>
        <p>
          While a government delegation attempted to dissuade Jarange-Patil from
          marching to Mumbai, he insisted on the Chief Minister and deputy Chief
          Ministers personally engaging in discussions to resolve the issue.
          Addressing concerns raised by the Navi Mumbai police, Jarange-Patil
          stated that local organizers should address route changes and
          reiterated his determination to proceed as planned.
        </p>
        <p>
          In response to the police notice, the Mumbai march organizers, led by
          Virendra Pawar, engaged with officials at Azad Maidan police station,
          expressing discontent with the last-minute notice and reaffirming
          their decision to proceed with the originally planned program.
        </p>
      </div>
    ),
  },
  {
    id: "with-lord-ramas-return-to-ayodhya-anticipate-a-resilient-and-confident-india",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/with-lord-ramas-return-to-ayodhya-anticipate-a-resilient-and-confident-india.avif`,
    title: `With Lord Rama's Return to Ayodhya, Anticipate a Resilient and Confident India`,
    preArticle: `On January 22, 2024, Prime Minister Narendra Modi conducted the pran pratishtha ceremony for the Ram Mandir at Ram Janmabhoomi in Ayodhya. Guided by revered pandits and Vedic Brahmins, the Prime Minister's ritual marked a momentous occasion for Sanatanis worldwide, culminating in the constitutional `,
    article: (
      <div className="space-y-6">
        <p>
          On January 22, 2024, Prime Minister Narendra Modi conducted the pran
          pratishtha ceremony for the Ram Mandir at Ram Janmabhoomi in Ayodhya.
          Guided by revered pandits and Vedic Brahmins, the Prime
          Minister&apos;s ritual marked a momentous occasion for Sanatanis
          worldwide, culminating in the constitutional realization of
          Hindus&apos; right to build a temple for Lord Ram after a painstaking
          500-year wait.
        </p>
        <p>
          This prolonged wait has been fraught with challenges and shared
          community memories, particularly for Ayodhya&apos;s Suryavanshi
          Kshatriyas, believed to be Lord Ram&apos;s descendants. Raja Gajraj
          Singh, leading the Suryavanshis, fiercely resisted Babur&apos;s army
          during the seizure of Ayodhya, vowing not to wear ceremonial turbans
          until the temple&apos;s restoration. Generations later, they once
          again don turbans as a symbol of reclamation. Other faiths, including
          Sikhism, played a role in reclaiming the temple, as evidenced by Guru
          Nanak Dev&apos;s visit in 1510, a point emphasized in the Supreme
          Court&apos;s 2019 judgment. The prelude to the pran pratishtha
          included the &quot;Akhand Path,&quot; a continuous 48-hour recitation
          of the Guru Granth Sahib.
        </p>
        <p>
          Celebrations echo across India and globally, commemorating the
          500-year wait in diverse ways. From Kutch to Kohima, Kashmir to
          Kanyakumari, and beyond international borders, communities join in
          this historic moment. Unfortunately, some choose not to participate,
          driven by a minority-appeasement mindset. This refusal stems from a
          skewed political prism that fails to recognize the significance of
          Sanatan Dharma in India&apos;s diverse tapestry.
        </p>
        <p>
          The Congress Party, historically uncomfortable with India&apos;s
          civilizational heritage, exemplifies this attitude. In 1947, Prime
          Minister Nehru opposed rebuilding the Somnath Temple, reflecting
          disdain for Hinduism. In 2007, the Congress government sought to
          dismantle the Ram Setu, dismissing mythological texts as
          non-historical. This pattern of discomfort with India&apos;s rich
          cultural heritage resurfaced in the run-up to the Ayodhya pran
          pratishtha.
        </p>
        <p>
          The events leading to the Ayodhya ceremony mirror those preceding the
          revival of Somnath post-independence. The Congress party&apos;s
          discomfort with our civilizational heritage, coupled with a misguided
          political calculation, is evident. This warped thinking is an affront
          to the nation&apos;s minorities. The Shah Bano incident in the 1980s
          exemplifies the consequences of such twisted political calculations,
          perpetuating the marginalization of Muslim women&apos;s rights.
        </p>
        <p>
          The restoration of the Ram Mandir in Ayodhya stands as an epochal
          event, reshaping the trajectory of the nation. As Lord Ram returns to
          Ayodhya, India is poised to become a more robust and confident nation,
          dedicated to the well-being and upliftment of all its citizens – a
          true manifestation of the promise of Ram Rajya.
        </p>
      </div>
    ),
  },
  {
    id: "independent-mla-steps-down-plans-to-rejoin-bjp",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/independent-mla-steps-down-plans-to-rejoin-bjp.jpg`,
    title: `Independent MLA Steps Down, Plans to Rejoin BJP`,
    preArticle: `Independent MLA Dharmendrasinh Vaghela, representing Waghodia in Vadodara, submitted his resignation from the state Assembly on Thursday. He cited the desire of his constituents to "strengthen the hands of Prime Minister Narendra Modi" as the reason for stepping down. With this move, Vaghela becomes`,
    article: (
      <div className="space-y-6">
        <p>
          Independent MLA Dharmendrasinh Vaghela, representing Waghodia in
          Vadodara, submitted his resignation from the state Assembly on
          Thursday. He cited the desire of his constituents to &quot;strengthen
          the hands of Prime Minister Narendra Modi&quot; as the reason for
          stepping down. With this move, Vaghela becomes the fourth MLA to
          resign from the Gujarat Assembly recently, reducing its strength to
          178 from the initially formed Assembly in December 2022.
        </p>
        <p>
          The trio of other resignations includes AAP Visavadar MLA Bhupendra
          Bhayani and Congress MLAs Chirag Patel and C J Chavda from Khambhat
          and Vijapur constituencies, respectively.
        </p>
        <p>
          Following his resignation, Vaghela expressed his gratitude to the
          voters who wished to bolster Prime Minister Narendra Modi and
          clarified that he harbors no grievances towards the BJP, signaling his
          imminent return to the party.
        </p>
        <p>
          Vaghela, one of three Independent candidates elected in the 15th
          Gujarat Assembly in December 2022, joined fellow Independents
          Dhavalsinh Zala and Mavji Desai in declaring support for the BJP in
          Gujarat. In the 2022 elections, Vaghela contested as an Independent
          after the BJP denied him a ticket and secured victory over BJP’s
          Ashwin Patel by over 14,000 votes.
        </p>
        <p>
          Mukul Wasnik, a senior Congress leader, criticized the BJP&apos;s
          approach of acquiring Opposition MLAs, labeling it as detrimental to
          democracy and politics. He expressed concern over the BJP&apos;s
          tactics of pressuring and buying legislators, deeming it damaging to
          democracy. Wasnik emphasized the Congress party&apos;s commitment to
          ideology and vowed to address disgruntled leaders to prevent further
          defections.
        </p>
        <p>
          Wasnik&apos;s statements came in the wake of ongoing resignations,
          including three-time Congress MLA CJ Chavda&apos;s recent departure
          from the Assembly, and AAP MLA Bhupendra Bhayani&apos;s resignation
          the previous month. Wasnik, present in Ahmedabad for a meeting of the
          Gujarat Pradesh Election Committee to discuss potential Lok Sabha
          candidates, stressed the need for dialogue with dissatisfied leaders
  ...
  {
    id: "modi-and-macron-conduct-jaipur-roadshow-pause-for-tea",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/modi-and-macron-conduct-jaipur-roadshow-pause-for-tea.avif`,
    title: `Modi and Macron Conduct Jaipur Roadshow, Pause for Tea`,
    preArticle: `Prime Minister Narendra Modi and French President Emmanuel Macron engaged in a vibrant roadshow in Jaipur on Thursday, culminating with dinner at Rambagh Palace before their journey to New Delhi, where Macron assumes the role of chief guest at the Republic Day parade on Friday. Macron, arriving in `,
    article: (
      <div className="space-y-6">
        <p>
          Prime Minister Narendra Modi and French President Emmanuel Macron
          engaged in a vibrant roadshow in Jaipur on Thursday, culminating with
          dinner at Rambagh Palace before their journey to New Delhi, where
          Macron assumes the role of chief guest at the Republic Day parade on
          Friday.
        </p>
        <p>
          Macron, arriving in Jaipur earlier that day, received a replica of the
          Ram Temple in Ayodhya from Modi, who facilitated the transaction using
          UPI and briefed the French President on the process. The leaders also
          made a delightful stop to savor tea in traditional earthen cups.
        </p>
        <p>
          Upon landing at the airport, Macron was warmly welcomed by External
          Affairs Minister Dr. S Jaishankar, Rajasthan Chief Minister Bhajan Lal
          Sharma, and Governor Kalraj Mishra. His itinerary included visits to
          iconic sites like the historic Amber Fort, a UNESCO World Heritage
          Site. En route, thousands of school children and locals lined the
          streets to greet him.
        </p>
        <p>
          At Amber, Macron, accompanied by Jaishankar and Deputy CM Diya Kumari,
          received a grand welcome with a red carpet, adorned elephants, and
          lively Kachhi Ghodi folk dancers. During his visit, Macron interacted
          with students, some fluent in French, and local artists.
        </p>
        <p>
          Subsequently, Macron proceeded to Jaipur’s Jantar Mantar, where PM
          Modi greeted him with a warm embrace. The leaders explored the
          astronomical observatory established by 18th-century ruler Sawai Jai
          Singh, also designated as a UNESCO World Heritage Site. Modi
          underscored the observatory&apos;s significance, symbolizing the
          convergence of ancient wisdom and modern science.
        </p>
        <p>
          Following this, Modi and Macron embarked on a roadshow through parts
          of the old walled city, where they were enthusiastically welcomed by
          large crowds. The city, festively adorned for the occasion, featured
          massive cutouts and hoardings of the leaders, with banners expressing
          a warm &quot;Bienvenue&quot; – French for welcome. The leaders even
          paused for a selfie during the roadshow.
        </p>
        <p>
          Modi and Macron made a noteworthy stop at Hawa Mahal and explored
          local shops in the old city. At a shop, Modi purchased a replica of
          the Ram Temple in Ayodhya as a gift for Macron, demonstrating the
          transaction through UPI. The leaders also enjoyed a tea break at the
          renowned Sahu tea stall, opting for traditional earthen cups. Macron,
          in a video, appreciated the uniqueness of the cups, while Modi
          highlighted their environmental friendliness and distinctive earthy
          flavor. Once again, the PM completed the payment through UPI.
        </p>
        <p>
          The roadshow concluded at Sanganeri Gate, followed by a dinner at
          Rambagh Palace in Jaipur before their departure for New Delhi.
        </p>
      </div>
    ),
  },
  {
    id: "hamari-virasat-presents-75-textiles-commemorating-75-years-of-indias-constitution",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/hamari-virasat-presents-75-textiles-commemorating-75-years-of-indias-constitution.avif`,
    title: `‘Hamari Virasat’ Presents 75 Textiles Commemorating 75 Years of India’s Constitution`,
    preArticle: `Artisans from various regions across India have united under the banner of "Hamari Virasat," a mobile exhibition celebrating the diverse textile heritage of the country in honor of the 75th anniversary of the adoption of the Indian Constitution on January 26, 1950. Showcased at Cross Maidan as part`,
    article: (
      <div className="space-y-6">
        <p>
          Artisans from various regions across India have united under the
          banner of &quot;Hamari Virasat,&quot; a mobile exhibition celebrating
          the diverse textile heritage of the country in honor of the 75th
          anniversary of the adoption of the Indian Constitution on January 26,
          1950.
        </p>
        <p>
          Showcased at Cross Maidan as part of the ongoing Kala Ghoda Art
          Festival, the exhibition, organized by the Hand for Handmade
          Foundation, has captivated a youthful audience participating in
          activities such as &quot;Preamble Jumble&quot; and exploring the
          original copy of the Constitution.
        </p>
        <p>
          Each exhibit in the collection draws inspiration from the Preamble,
          embodying its commitment &quot;to constitute India into a Sovereign,
          Socialist, Secular, Democratic, Republic,&quot; incorporating design
          elements like the bull, lotus, elephant, peacock, horse, lion, and
          various geometric and floral motifs.
        </p>
        <p>
          Shibani Dasgupta Jai, co-founder of Hand for Handmade Foundation,
          expressed the initiative&apos;s goal of involving artisans from all
          corners of India in commemorating the significant milestone of 75
          years since the adoption of the Indian Constitution. They collaborated
          with We The People Abhiyaan as the knowledge partner, presenting the
          Preamble to artisans and elucidating its meanings.
        </p>
        <p>
          &quot;Each piece reflects the inspiration they drew from the words and
          motifs, representing their contribution to the celebration,&quot; said
          Shibani Dasgupta Jai. The exhibition features a nomadic textile
          handwoven in Ladakh, showcasing the warp and weft technique adorned
          with tribal motifs, as well as a traditional textile from the Mishing
          tribes of Assam. The objective is to foster a connection between
          people and these artworks, fostering appreciation for the rich
          textiles and crafts that thrive in India.
        </p>
        <p>
          &quot;Hamari Virasat&quot; is available for viewing at Cross Maidan
          until January 28. Following this, the exhibition will travel to other
          major cities, beginning with New Delhi in February, providing visitors
          with the opportunity to purchase crafts from some of the participating
          artisans.
        </p>
      </div>
    ),
  ...
  {
    id: "air-india-consortium-plans-to-add-an-aircraft-every-six-days-in-the-coming-year",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/air-india-consortium-plans-to-add-an-aircraft-every-six-days-in-the-coming-year.jpg`,
    title: `Air India Consortium Plans to Add an Aircraft Every Six Days in the Coming Year`,
    preArticle: `The Air India group has outlined ambitious plans for 2024, intending to add an average of one aircraft every six days throughout the year. This includes the incorporation of five additional Airbus A350 wide-body aircraft, along with 46 Boeing 737 and 17 Airbus A320 narrow-body planes, as revealed by`,
    article: (
      <div className="space-y-6">
        <p>
          The Air India group has outlined ambitious plans for 2024, intending
          to add an average of one aircraft every six days throughout the year.
          This includes the incorporation of five additional Airbus A350
          wide-body aircraft, along with 46 Boeing 737 and 17 Airbus A320
          narrow-body planes, as revealed by Air India’s CEO and Managing
          Director, Campbell Wilson. These additions are part of the extensive
          470-aircraft order placed in 2023. In addition to these, four leased
          Boeing 777 wide-body planes will join the Air India fleet.
        </p>
        <p>
          Currently operating with 117 operational aircraft, and its subsidiary,
          Air India Express, with 63 planes, the Air India group, under new
          ownership, has successfully reintroduced 90% of its previously
          grounded aircraft to service.
        </p>
        <p>
          Beyond fleet expansion, 2024 will witness Air India commencing the
          complete interior refurbishment of 40 legacy wide-body aircraft,
          including Boeing 777s and 787s. The overhaul, starting in July, will
          encompass the replacement of seats and in-flight entertainment systems
          on the legacy wide-body fleet, coinciding with the initiation of
          international operations for Air India’s first A350 aircraft. This
          aircraft, having recently commenced commercial operations, will
          initially operate on domestic sectors for a few months for crew
          familiarization flights. Additionally, interior upgrades for 41
          narrow-body A320 aircraft are also planned for this year.
        </p>
        <p>
          Campbell Wilson emphasized the progress made in the past two years
          since privatization, acknowledging the need to further upgrade the
          legacy fleet, enhance consistency, address remaining gaps, and fortify
          fragile processes. He expressed optimism about the visible and
          tangible future, encouraging the airline to rise to meet the high
          expectations.
        </p>
        <p>
          Over the last two years, Air India has expanded its legacy fleet with
          36 leased aircraft and placed a substantial order for 470 aircraft
          with Airbus and Boeing. The airline has introduced five domestic and
          11 international routes, inaugurated five new international stations,
          and launched new brand identities for both Air India and Air India
          Express.
        </p>
        <p>
          Since returning to the Tata group on January 27, 2022, Air India has
          focused on enhancing its product offerings and planning extensive
          expansions. The Vihaan.AI five-year roadmap was designed to
          substantially grow the airline’s network and fleet, aiming for
          sustained growth, profitability, and market leadership.
        </p>
        <p>
          According to data shared by Wilson, Air India achieved a remarkable
          249% revenue growth over the past two years, while Air India Express
          witnessed a 148% revenue growth. Although specifics about the group’s
          financials were not provided, Wilson acknowledged the significant
          progress made in a short time, attributing it to the commitment,
          energy, and hard work of the Air India team.
        </p>
        <p>
          The Tata group is in the process of consolidating its airline business
          by merging Air India and Vistara to create a single full-service
          carrier under the Air India brand. Additionally, Air India Express and
          AIX Connect (formerly AirAsia India) are being merged to form a single
          budget airline under the Air India Express brand. While the
          operational integration of Air India Express and AIX Connect is
          complete, the merger of Air India and Vistara is anticipated in 2025.
        </p>
      </div>
    ),
  },
  {
    id: "kerala-court-hands-down-150-year-sentence-to-man-for-raping-minor-daughter",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/kerala-court-hands-down-150-year-sentence-to-man-for-raping-minor-daughter.webp`,
    title: `Kerala Court Hands Down 150-Year Sentence to Man for Raping Minor Daughter`,
    preArticle: `In a significant judgment, a Kerala court has handed down a cumulative sentence of 150 years to a 42-year-old man convicted of repeatedly raping his minor daughter. The heinous crimes took place in the man's residence near Perinthalmanna. The Fast Track Special Court-II judge, Sini S R, pronounced t`,
    article: (
      <div className="space-y-6">
        <p>
          In a significant judgment, a Kerala court has handed down a cumulative
          sentence of 150 years to a 42-year-old man convicted of repeatedly
          raping his minor daughter. The heinous crimes took place in the
          man&apos;s residence near Perinthalmanna. The Fast Track Special
          Court-II judge, Sini S R, pronounced the verdict, imposing various
          sentences under the Protection of Children from Sexual Offenses
          (POCSO) Act, IPC, and the Juvenile Justice Act.
        </p>
        <p>
          The convicted individual, who has three wives, including the minor
          victim&apos;s mother, received sentences that add up to 150 years.
          However, since the sentences are to be served concurrently and the
          longest jail term is 40 years, the man will ultimately serve 40 years
          in prison, as clarified by the court order available on the official
          website.
        </p>
        <p>
          Under the IPC and POCSO Act, the court sentenced the man to 30 years
          each for the offenses related to rape and penetrative sexual assault
          on a child under sixteen years of age. Additionally, he received 40
          years each for the offenses of penetrative sexual assault on a child
          more than once or repeatedly and penetrative sexual assault on a child
          by a relative through blood, adoption, or marriage.
        </p>
        <p>
          Further, the man faced a seven-year sentence for the offense of house
          trespass under the IPC and a three-year sentence under the Juvenile
          Justice Act for cruelty to a child.
        </p>
        <p>
          In addition to the imprisonment, the court imposed a total fine of Rs
          four lakh, with Rs two lakh directed to be paid as compensation to the
          victim. The District Legal Services Authority, Manjeri, has been
          recommended to determine the compensation amount under the Victim
          Compensation Scheme.
        </p>
        <p>
          The disturbing incident occurred in 2022, as reported by the Kalikavu
          police station, the jurisdiction where the crime took place. According
          to the police, the minor victim is the daughter of one of the three
          wives of the convicted individual, and the assaults occurred when
          there was no one else present at home.
        </p>
      </div>
    ),
  },
  {
    id: "fisherman-arrested-after-attempting-to-sell-abandoned-sea-cargo-of-hashish-valued-at-rs80-lakh",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/fisherman-arrested-after-attempting-to-sell-abandoned-sea-cargo-of-hashish-valued-at-rs80-lakh.jpg`,
    title: `Fisherman Arrested After Attempting to Sell Abandoned Sea Cargo of Hashish Valued at Rs 80 Lakh`,
    preArticle: `Thane's crime branch officials arrested a 42-year-old fisherman, Abhay Parshuram Pagdhare, on Wednesday, seizing eight kilograms of charas (hashish) valued at Rs 80 lakh. Pagdhare claimed that his brother discovered the abandoned drug packet near the sea, believed to be part of a major drug consignm`,
    article: (
      <div className="space-y-6">
        <p>
          Thane&apos;s crime branch officials arrested a 42-year-old fisherman,
          Abhay Parshuram Pagdhare, on Wednesday, seizing eight kilograms of
          charas (hashish) valued at Rs 80 lakh. Pagdhare claimed that his
          brother discovered the abandoned drug packet near the sea, believed to
          be part of a major drug consignment dumped by a larger racket in the
          sea. Attempting to capitalize on the opportunity, Pagdhare and his
          brother sought to sell the drugs but were apprehended by the police.
        </p>
        <p>
          Thane Police Commissioner Ashutosh Dumbre confirmed the arrest,
          emphasizing the authorities&apos; strong stance against both drug
          traffickers and consumers.
        </p>
        <p>
          Pagdhare, a resident of Dahanu taluka in Palghar district, was
          apprehended at the &apos;I Love Majiwada&apos; junction in Thane,
          based on reliable information received by Crime Branch Unit-5 Senior
          Inspector Vikas Ghodke. A bag containing 8 kilograms of charas was
          seized from Pagdhare during the arrest.
        </p>
        <p>
          During questioning, Pagdhare disclosed that his brother found the drug
          packet off the coast near Gujarat. His brother handed it over to
          Pagdhare, who attempted to sell it for quick profit, according to a
          crime branch officer.
        </p>
        <p>
          The seized drugs are believed to be part of a large drug consignment
          discovered abandoned off the Raigad and Ratnagiri beaches last year.
          Initially, over 278 kg of hashish was found on seven different
          Ratnagiri beaches from August 14 to 22. Subsequently, on the Raigad
          coast, 175 packets of hashish, totaling 209.13 kg and worth ₹8.36
          crore, were found on five beaches.
        </p>
        <p>
          &quot;Some fishermen had discovered the drug packets, and they all
          returned them to the police. However, a few did not. Later, some of
          them were arrested as well. We suspect Pagdhare and his brother could
          be from that group. We are investigating Pagdhare&apos;s
          brother&apos;s involvement,&quot; said another police officer.
        </p>
      </div>
    ),
  },
  {
    id: "dg-prashant-kumar-and-dig-manzil-saini-to-be-honored-with-presidents-medal-for-bravery",
    timestamp: "Jan 26, 2024",
    image: `/breaking/jan-26-2024/dg-prashant-kumar-and-dig-manzil-saini-to-be-honored-with-presidents-medal-for-bravery.jpg`,
    title: `DG Prashant Kumar and DIG Manzil Saini to be honored with President's Medal for bravery`,
    preArticle: `Uttar Pradesh Police's Director General of Law and Order, Prashant Kumar, and Deputy Inspector General of Police, Manzil Saini, are set to be honored with the President's Medal for gallantry on Republic Day. This recognition stems from their pivotal roles in the apprehension of four individuals accu`,
    article: (
      <div className="space-y-6">
        <p>
          Uttar Pradesh Police&apos;s Director General of Law and Order,
          Prashant Kumar, and Deputy Inspector General of Police, Manzil Saini,
          are set to be honored with the President&apos;s Medal for gallantry on
          Republic Day. This recognition stems from their pivotal roles in the
          apprehension of four individuals accused of kidnapping Dr. Shrikant
          Goud, a doctor associated with a prominent hospital in Delhi, back in
          2017.
        </p>
        <p>
          The incident unfolded on July 6, 2017, when Dr. Shrikant Goud was
          abducted, and the captors demanded a ransom of Rs 5 crore for his
          release. A collaborative effort between Meerut police and their
          counterparts in Delhi resulted in the successful rescue of Dr. Srikant
          Goud from the kidnappers on July 19, 2017.
        </p>
        <p>
          At the time of the arrests and the subsequent rescue operation,
          Prashant Kumar held the position of Additional Director General
          (Meerut zone), while Manzil Saini served as the Meerut Senior
          Superintendent of Police. Prashant Kumar, a 1990-batch IPS officer, is
          set to receive his fourth President&apos;s Medal, having been
          previously honored in 2020, 2021, and 2022 with the President&apos;s
          Police Medal for bravery.
        </p>
        <p>
          In addition to Kumar and Saini, seven other police officers will be
          presented with the President&apos;s Medal for Distinguished Service,
          while 74 officers will be recognized with meritorious service medals.
        </p>
        <p>
          Among those receiving the President&apos;s Medal for Distinguished
          Service are five Additional Director General-rank officers: Sujeet
          Pandey, Dr. KS Pratap Kumar, Piyush Mordia, and Bhagwan Swaroop
          Srivastava.
        </p>
        <p>
          Furthermore, meritorious service medals will be bestowed upon 74
          police personnel, including two Inspector General-rank officers:
          Akhilesh Kumar Meena and Deepak Kumar.
        </p>
        <p>
          In addition to these prestigious awards, 744 other police personnel
          will be recognized by the UP Director General of Police for their
          outstanding contributions and distinguished services.
        </p>
      </div>
    ),
  },
  ...
  // jan-22-2024
  {
    ...
    image: `/breaking/jan-22-2024/the-supreme-court-reprimands-the-tamil-nadu-government-for-restricting-the-telecast-of-the-ram-temple-event.jpg`,
    title: `The Supreme Court reprimands the Tamil Nadu government for restricting the telecast of the Ram Temple event`,
    preArticle: `The Supreme Court today raised concerns regarding the alleged verbal directive from the Tamil Nadu government to prohibit live broadcasts of the 'Pran Prathishta' ceremony of Ram Lalla at Ayodhya in temples across the state. The court emphasized that the state government cannot impose such bans base`,
    article: (
      <div className="space-y-6">
        <p>
          The Supreme Court today raised concerns regarding the alleged verbal
          directive from the Tamil Nadu government to prohibit live broadcasts
          of the &apos;Pran Prathishta&apos; ceremony of Ram Lalla at Ayodhya in
          temples across the state. The court emphasized that the state
          government cannot impose such bans based on the argument that Hindus
          constitute a &quot;minority&quot; in certain regions.
        </p>
        <p>
          In response to the counsel representing the Tamil Nadu government, the
          bench, comprising Justices Sanjiv Khanna and Dipankar Datta, asserted
          that the society is homogenous, and permissions for events should not
          be denied solely because of the presence of different communities in a
          particular area.
        </p>
        <p>
          Expressing disapproval of the alleged general order issued by the
          Tamil Nadu government, the bench labeled such directives as
          &quot;atrocious&quot; and instructed the state authorities not to
          summarily reject permission requests. The court emphasized the need
          for adherence to the law and highlighted that authorities should
          evaluate applications seeking permission for live telecasts and handle
          them in accordance with legal procedures. The court also insisted that
          if a request is denied, proper reasons must be provided for the
          rejection.
        </p>
        <p>
          The Supreme Court issued a notice to the Tamil Nadu government and
          others in response to a plea filed by BJP&apos;s State Unit Secretary
          Vinoj P Selvam challenging the oral order that banned the live
          telecast of the &quot;Pran Prathishta&quot; ceremony of Ram Lalla in
          temples across the state.
        </p>
        <p>
          During the proceedings, the Tamil Nadu government asserted that there
          were no such restrictions, emphasizing that there was no ban on live
          telecasts, poojas, archanas, annadhanas, or bhajans during the
          &quot;Pran Prathishta&quot; ceremony of Lord Ram at Ayodhya. The
          government argued that the plea was politically motivated.
        </p>
        <p>
          Senior counsel Dama Seshadri Naidu, representing the petitioner,
          argued that certain police orders had imposed a ban on live-streaming
          and other religious activities related to the ceremony at
          Ayodhya&apos;s Ram Janmabhoomi Temple. He contended that the orders
          were driven by political motives, alleging a disdain for religion by
          the ruling party.
        </p>
        <p>
          Solicitor General of India Tushar Mehta, representing the Central
          government, expressed shock at the situation and urged the Supreme
          Court to send a strong message to the state government. He emphasized
          that the Constitution of India governs the nation, including the state
          of Tamil Nadu, and stated that religious rituals should not be
          obstructed. Mr. Mehta pointed out that LED screenings in temples were
          being halted in the state.
        </p>
        <p>
          The bench sought clarification from the Tamil Nadu government
          regarding the reasons behind the ban and expressed displeasure upon
          reviewing the orders presented by the petitioner&apos;s counsel.
          Justice Datta criticized the notion that denials were based on the
          minority status of certain communities in the requested locations,
          stating that such reasons were &quot;atrocious&quot; and suggested
          that, if followed, they would prevent any procession or ritual across
          the state.
        </p>
        <p>The matter has been scheduled for further hearing on January 29.</p>
      </div>
    ),
  },
  {
    id: "virender-sehwag-and-shoaib-akhtar-in-funny-banter-over-pacers-run-up",
    timestamp: "Jan 22, 2024",
    image: `/breaking/jan-22-2024/virender-sehwag-and-shoaib-akhtar-in-funny-banter-over-pacers-run-up.jpeg`,
    title: ` Virender Sehwag and Shoaib Akhtar in funny banter over pacer's run-up `,
    preArticle: `Former cricket stars Virender Sehwag and Shoaib Akhtar entertained fans with their hilarious banter in a recent social media post. Akhtar shared a video where Sehwag poked fun at the pace legend's famously long run-up. Despite being rivals on the field, the two share great camaraderie off it. "My`,
    article: (
      <div className="space-y-6">
        <p>
          Former cricket stars Virender Sehwag and Shoaib Akhtar entertained
          fans with their hilarious banter in a recent social media post. Akhtar
          shared a video where Sehwag poked fun at the pace legend&apos;s
          famously long run-up.{" "}
        </p>
        <p>
          Despite being rivals on the field, the two share great camaraderie off
          it. &quot;My dear friend Viru @virendersehwag saying how my long
          run-up used to make him wait and distract him,&quot; Akhtar captioned
          the post.{" "}
        </p>
        <p>
          In the video, Sehwag says he would keep looking down knowing it took
          Akhtar 10-15 seconds to finish his run-up. When asked if it was
          distracting, Sehwag quipped that many thoughts would run through his
          mind - &quot;Will he hit my toes or beamer on my head or hit me
          somewhere else?&quot;
        </p>
        <p>
          Sehwag retired as one of India&apos;s most prolific batters with 8,586
          Test runs at a stellar average of 49.34 from 104 matches. He amassed
          8,273 ODI runs from 251 games with a strike rate of 104.33. In 19
          T20Is, he scored 394 runs.
        </p>
        <p>
          Akhtar played 46 Tests taking 178 wickets at 25.69. In 163 ODIs, he
          claimed 247 wickets at 24.97 average. He also took 19 wickets in 15
          T20Is for Pakistan.{" "}
        </p>
        <p>
          The lighthearted social media exchange gave fans a glimpse of
          Sehwag&apos;s famed wit and sense of humor. It also highlighted the
          warm ties between the two legends who were fierce competitors on the
          field.{" "}
        </p>
        <p>
          Their relaxed banter proves that sportsmanship and camaraderie can
          thrive between rivals beyond retirement. Moments like these are a
          reminder of cricket&apos;s unique power to bridge divides.
        </p>
        <p>
          Fans thoroughly enjoyed this mirthful interaction laced with mutual
          respect. Veterans regaling viewers with their anecdotes always makes
          for entertaining content. Akhtar and Sehwag continue to keep their
          fans smiling long after hanging up their boots.
        </p>
      </div>
    ),
  },
  {
    id: "employee-at-us-store-fatally-shot-over-bag-of-chips",
    timestamp: "Jan 22, 2024",
    image: `/breaking/jan-22-2024/employee-at-us-store-fatally-shot-over-bag-of-chips.webp`,
    title: ` Employee at US store fatally shot over bag of chips`,
    preArticle: `In a tragic incident, a 42-year-old employee at a convenience store in Texas was fatally shot after chasing two shoplifters who had stolen a bag of chips, as per a New York Post report. The shooting occurred around 11:30am at a Sunoco gas station shop. The store manager followed the alleged thiev`,
    article: (
      <div className="space-y-6">
        <p>
          In a tragic incident, a 42-year-old employee at a convenience store in
          Texas was fatally shot after chasing two shoplifters who had stolen a
          bag of chips, as per a New York Post report.{" "}
        </p>
        <p>
          The shooting occurred around 11:30am at a Sunoco gas station shop. The
          store manager followed the alleged thieves in his car to try stopping
          their theft but one of them opened fire, striking and killing the
          employee.
        </p>
        <div>
          <blockquote className="twitter-tweet">
            <p lang="en" dir="ltr">
              Capital Murder suspect info:
              <br />
              <br />
              Humble PD is actively looking for these suspects. If you have any
              information, please contact us at 281-447-7127, reference case
              number 24-000300.{" "}
              <a href="https://t.co/cshpghPrsA">pic.twitter.com/cshpghPrsA</a>
            </p>
            &mdash; HumblePoliceDept (@HumblePoliceDep){" "}
            <a href="https://twitter.com/HumblePoliceDep/status/1748564921644691835?ref_src=twsrc%5Etfw">
              January 20, 2024
            </a>
          </blockquote>{" "}
          <script
        ...
        <p>
          CCTV footage showed the two men entering the store while the manager
          walked behind with a mop bucket. The men browsed aisles before one
          concealed a bag of chips in his pants. They left without paying after
          several minutes.{" "}
        </p>
        <p>
          The clerk then confronted them outside before getting in his car to
          follow as they walked away. Humble Assistant Police Chief Dan Zientek
          said the victim tried reversing his car when the men began shooting,
          but ended up struck on the median.
        </p>
        <p>
          The 42-year-old was hit by a bullet while in the driver&apos;s seat.
          His car had bullet holes in the windshield and rear window. The
          culprits fled on foot and remain at large.
        </p>
        <p>
          Chief Zientek lamented the tragic loss of an innocent man &quot;just
          trying to work and do their job.&quot; He said the shooters had also
          ruined their own lives and would face jail.
        </p>
        <p>
          The senseless killing over something as trivial as a bag of chips has
          shocked the local community. It underscores the perils of retail work
          in a country awash with guns and gun violence.
        </p>
        <p>
          Store employees trying to stop petty thefts should not have to fear
          for their lives. While chasing the shoplifters was ill-advised, it did
          not warrant a death sentence on the spot without trial.
        </p>
        <p>
          The culprits must be swiftly brought to justice to send a strong
  ...
  },
  {
    ...
    timestamp: "Jan 22, 2024",
    image: `/breaking/jan-22-2024/ayodhya-adorned-for-festive-celebrations-as-the-stage-is-prepared-for-today-s-consecration-ceremony-of-the-ram-temple.webp`,
    title: `Ayodhya adorned for festive celebrations as the stage is prepared for today's consecration ceremony of the Ram temple`,
    preArticle: `The stage is set for the consecration ceremony of the new Ram idol at the Ayodhya temple on Monday. Diyas were lit, floral decorations adorned the columns and walls, around 8,000 chairs awaited special guests, and rituals continued all day Sunday ahe`,
    article: (
      <div className="space-y-6">
        <p>
          The stage is set for the consecration ceremony of the new Ram idol at
          the Ayodhya temple on Monday. Diyas were lit, floral decorations
          adorned the columns and walls, around 8,000 chairs awaited special
          guests, and rituals continued all day Sunday ahead of the &apos;Pran
          Pratishtha&apos; ceremony.
        </p>
        <div className="relative w-full h-72 sm:h-96 bg-slate-200 rounded-xl overflow-hidden">
          <Image
            priority
            src="/breaking/jan-22-2024/ayodhya-adorned-for-festive-celebrations-as-the-stage-is-prepared-for-today-s-consecration-ceremony-of-the-ram-temple(2).webp"
            alt="ayodhya-adorned-for-festive-celebrations-as-the-stage-is-prepared-for-today-s-consecration-ceremony-of-the-ram-temple(2)"
            fill
            sizes="auto"
            className="object-cover object-center"
          />
        ...
        <p>
          The festive town welcomed many visitors, with the event starting
          shortly after noon on Monday. Prime Minister Modi will arrive in
          Ayodhya at 10:45 am and be at the temple site by 10:55 am to
          participate in the ceremonies from 12:05 pm to 12:55 pm. He will then
          address a public gathering before visiting the Kuber Tila to offer
          prayers at the renovated Shiva temple and unveil a Jatayu statue.
        </p>
        <div className="relative w-full h-72 sm:h-96 bg-slate-200 rounded-xl overflow-hidden">
          <Image
            priority
            src="/breaking/jan-22-2024/ayodhya-adorned-for-festive-celebrations-as-the-stage-is-prepared-for-today-s-consecration-ceremony-of-the-ram-temple(3).webp"
            alt="ayodhya-adorned-for-festive-celebrations-as-the-stage-is-prepared-for-today-s-consecration-ceremony-of-the-ram-temple(3)"
            fill
            sizes="auto"
            className="object-cover object-center"
          />
        ...
        <p>
          A major part of the preparatory rituals that began on January 16th
          concluded on Sunday. The day started with the new 51-inch idol being
          covered with honey during the &apos;Madhvadhivas&apos; ritual. It was
          then bathed with medicated water from 114 urns as part of
          &apos;Snapan&apos;.
        </p>
        <p>
          The old idol was also taken around the new temple in a decorated
          palanquin before being brought inside. As the rituals continued into
          Sunday evening, the priests said the eyes of the new idol, which were
          closed on January 16th, will be opened after another purificatory
          bath. It will then be shown a mirror to absorb energies created by the
          rituals.
        </p>
        <p>
          Ghee and honey will also be applied to the eyes with a gold stick. The
          old idol will be similarly bathed and both idols placed inside the
          sanctum sanctorum. The preparatory rituals ended with
          &apos;Shayandhivas&apos;, symbolically putting the idol to sleep after
          six days of worship.
        </p>
        <p>
          Quilts from Jaipur and a carved sheesham bed adorned the idol on
          Sunday night. On Monday morning, priests will arrive by 8:30 am to
          complete the remaining rites. The sacred fire will continue burning
          even after the ceremony.
        </p>
        <p>
          The consecration of the new Ram Lalla idol marks the fulfillment of a
          decades-old movement. The festivities reflect the devout fervor
          sweeping Ayodhya as this historic moment arrives after years of
          anticipation. PM Modi&apos;s attendance underscores its importance for
          the nation.
        </p>
      </div>
    ),
  ...
  {
    id: "government-reports-81-of-responses-favor-simultaneous-elections-in-ram-nath-kovind-led-panel",
    timestamp: "Jan 22, 2024",
    image: `/breaking/jan-22-2024/government-reports-81-of-responses-favor-simultaneous-elections-in-ram-nath-kovind-led-panel.jpg`,
    title: `Government Reports: 81% of Responses Favor Simultaneous Elections in Ram Nath Kovind-Led Panel`,
    preArticle: `The Union Law Ministry stated on Sunday that a majority of the over 20,000 responses received by the high-level committee on 'One Nation, One Election' were in favor of holding simultaneous polls.  

The committee, chaired by former President Ram Nat`,
    article: (
      <div className="space-y-6">
        <p>
          The Union Law Ministry stated on Sunday that a majority of the over
          20,000 responses received by the high-level committee on &apos;One
          Nation, One Election&apos; were in favor of holding simultaneous
          polls.
        </p>
        <p>
          The committee, chaired by former President Ram Nath Kovind, held its
          third meeting on January 22nd. It had invited public suggestions
          through a notice on January 5th, with a deadline of January 15th.
          Feedback was also collected via the committee&apos;s website.
        </p>
        <p>
          Out of 20,972 total responses, 81% supported the idea of simultaneous
          elections across the country. The committee had also sought inputs
          from 46 political parties, out of which 17 have submitted their
          suggestions so far. The Election Commission of India&apos;s views were
          also recorded.
        </p>
        <p>
          Last week, Kovind held consultations with former Chief Election
          Commissioners Sushil Chandra and O.P. Rawat, former Madras High Court
          Chief Justice Munishwar Nath Bhandari, and former Delhi High Court
          Chief Justice G. Rohini. This was part of engaging with eminent
          jurists, ex-Supreme Court and High Court judges, past Chief Election
          Commissioners, and industry bodies.
        </p>
        <p>
          The ministry stated that the committee will hold its next meeting on
          January 27th. The panel was set up last September by the Law Ministry
          and has held two previous meetings. Its mandate is to examine and
          recommend holding simultaneous elections to the Lok Sabha, state
          assemblies, local bodies and panchayats.
        </p>
        <p>
          The move towards &apos;One Nation, One Election&apos; requires
          consensus among political parties. Critics have raised concerns about
          its feasibility in India&apos;s complex federal structure. But
          advocates argue it will cut election costs and provide policy
          continuity at the Centre and states.
        </p>
        <p>
          With a majority of public responses in favor, the committee has a
          strong endorsement for deliberating further reforms. Its
          recommendations will be crucial to build political and public
          acceptance for simultaneous polls. But implementing One Nation, One
          Election will ultimately need Constitutional amendments.
        </p>
        <p>
          The Law Ministry panel represents the government&apos;s most concrete
          step yet towards this long-pending electoral reform. Its consultative
          approach is welcome. Achieving simultaneous national and state
          elections will be challenging, but may strengthen governance in the
          long run if implemented judiciously.
        </p>
      </div>
    ),
  },
  {
    id: "amit-shah-urges-security-agencies-to-eradicate-maoists-from-chhattisgarh-within-a-3-year-timeframe",
    timestamp: "Jan 22, 2024",
    image: `/breaking/jan-22-2024/amit-shah-urges-security-agencies-to-eradicate-maoists-from-chhattisgarh-within-a-3-year-timeframe.avif`,
    title: `Amit Shah urges security agencies to eradicate Maoists from Chhattisgarh within a 3-year timeframe`,
    preArticle: `Home Minister Amit Shah chaired a key meeting in Raipur on Sunday to review the efforts to curb Left Wing Extremism (LWE) in Chhattisgarh. The objective is to eliminate the Maoist threat in the state within three years. 

In attendance were the Chief`,
    article: (
      <div className="space-y-6">
        <p>
          Home Minister Amit Shah chaired a key meeting in Raipur on Sunday to
          review the efforts to curb Left Wing Extremism (LWE) in Chhattisgarh.
          The objective is to eliminate the Maoist threat in the state within
          three years.
        </p>
        <p>
          In attendance were the Chief Minister, Deputy Chief Ministers, the
          Union Home Secretary, Intelligence Bureau Director, CRPF Director
          General, Chhattisgarh Chief Secretary, and the state police chief.
        </p>
        <p>
          Shah noted that joint efforts by central and state security forces
          have contained Maoist activities to some pockets. But a targeted plan
          is now needed to dismantle the entire support ecosystem of the rebels.
        </p>
        <p>
          The Home Minister directed the state police to boost security, conduct
          thorough probes, closely monitor court cases, choke funding channels
          and continue intelligence-based operations. He stressed
          operationalizing all actionable inputs shared through the Multi-Agency
          Centre.
        </p>
        <p>
          Shah underlined the need to ensure complete coverage of central and
          state welfare schemes in Maoist-hit districts. He said the Home
          Ministry should allow flexibility in allotting and utilizing funds in
          these areas.
        </p>
        <p>
          The Home Minister emphasized sensitively addressing all legitimate
          grievances of locals regarding entitlements. Following this, the Union
          Home Secretary interacted in detail with district police chiefs and
          administrators of the worst LWE-hit districts.
        </p>
        <p>
          The high-level meeting reflects the resolve to decisively end
          left-wing extremism in Chhattisgarh. The state has seen some of the
          deadliest Maoist attacks in the past decade despite sustained
          counter-insurgency efforts.
        </p>
        <p>
          Shah&apos;s emphasis on choking funding channels is critical as
          extortion remains a big source of income for Maoists. Strengthening
          local governance delivery will be equally important to wean away
          popular support from rebels.
        </p>
        <p>
          Chhattisgarh police have the experience and motivation needed for the
          final push against extremists. Central assistance can plug gaps in
          resources and capabilities. But ultimately, the key will lie in
          granular, district-specific plans rooted in local realities.
        </p>
        <p>
          Much progress has been made, but the last mile will be the toughest.
          Concerted action across multiple fronts in the coming years can help
          fulfill the Home Minister&apos;s vision of making Chhattisgarh
          Maoist-free. It will require political will, administrative
          coordination and security force professionalism.
        </p>
      </div>
    ),
  },
  {
    id: "bilkis-bano-case-convicts-surrender-reaching-godhra-jail-close-to-the-deadline",
    timestamp: "Jan 22, 2024",
    image: `/breaking/jan-22-2024/bilkis-bano-case-convicts-surrender-reaching-godhra-jail-close-to-the-deadline.webp`,
    title: `Bilkis Bano case convicts surrender, reaching Godhra jail close to the deadline`,
    preArticle: `The eleven men convicted for the 2002 gang rape of Bilkis Bano and murder of her family members turned themselves in to authorities late Sunday night at the Godhra jail. This comes after the Supreme Court revoked the premature release granted to them`,
    article: (
      <div className="space-y-6">
        <p>
          The eleven men convicted for the 2002 gang rape of Bilkis Bano and
          murder of her family members turned themselves in to authorities late
          Sunday night at the Godhra jail. This comes after the Supreme Court
          revoked the premature release granted to them by the Gujarat
          government on August 15th last year and ordered them to surrender
          within two weeks.
        </p>
        <p>
          The eleven men - Radheshyam Shah, Jaswant Nai, Govind Nai, Kesar
          Vohania, Baka Vohania, Raju Soni, Ramesh Chandana, Shailesh Bhatt,
          Bipin Joshi, Pradip Modhiya, and Mitesh Bhatt - arrived at the jail in
          Godhra from Singwad village in two separate vehicles shortly before
          midnight. Most came in a ten-seater van led by an SUV. The district
          police confirmed they had monitored and escorted the men into the
          jail.
        </p>
        <p>
          In preparation for the surrender, police units were deployed outside
          the jail since Sunday evening. The jail authorities verified that the
          eleven men turned themselves in at 11:45pm on Sunday, just meeting the
          Supreme Court&apos;s stipulated deadline.
        </p>
        <p>
          This comes after the Supreme Court dismissed petitions from the men
          earlier last week asking for more time to surrender. They had cited
          reasons like caring for elderly parents, an upcoming wedding, and
          needing to harvest crops.
        </p>
        <p>
          On January 8th, the Supreme Court overturned the Gujarat
          government&apos;s decision to grant remission and release the men.
          They had been sentenced to life in prison for the rape of Bano and
          murder of her family members during the 2002 Gujarat riots. The Court
          ruled that the Gujarat government lacked the authority to grant
          remission, which should have been decided by the Maharashtra
          government.
        </p>
        <p>
          The men were originally released on August 15th under Gujarat&apos;s
          1992 remission policy based on a Supreme Court order in May 2022 in a
          petition filed by one of the convicts, Radheshyam Shah. Bano
          challenged the release, leading to the January 8th ruling reversing
          it.
        </p>
        <p>
          Bano was 21 years old and five months pregnant when she was raped by
          multiple men as she fled riot violence in 2002, which also claimed the
  ...
  // jan-14-2024
  {
    id: "military-commences-operation-to-foil-pakistans-attempt-to-resurrect-terrorism-in-jammu-and-kashmir",
    timestamp: "Jan 14, 2024",
    image:
      "/jan-14-2024/military-commences-operation-to-foil-pakistans-attempt-to-resurrect-terrorism-in-jammu-and-kashmir.avif",
    title: `Military Commences Operation to Foil Pakistan's Attempt to Resurrect Terrorism in Jammu and Kashmir`,
    preArticle: `The Indian Army is launching a major counterterrorism operation called
          Operation Sarvashakti in Jammu and Kashmir in response to Pakistan's
          attempts to increase terrorist activities in the region. The goal is
          to target terrorists operating on both sides of the Pir Panjal
          mountain range which runs through the Union Territory.`,
    article: (
      <div className="space-y-6">
        <p>
          The Indian Army is launching a major counterterrorism operation called
          Operation Sarvashakti in Jammu and Kashmir in response to
          Pakistan&apos;s attempts to increase terrorist activities in the
          region. The goal is to target terrorists operating on both sides of
          the Pir Panjal mountain range which runs through the Union Territory.
        </p>
        <p>
          In recent times, Pakistan has been supporting and directing terrorist
          groups to try to revive terrorism in the areas south of the Pir Panjal
          range, especially in the Rajouri and Poonch districts. Around 20
          Indian troops have been killed there in attacks by Pakistan-backed
          terrorists, with the most recent attack occurring on December 21 in
          the Dera ki Gali area where 4 soldiers were killed.
        </p>
        <p>
          Operation Sarvashakti will involve combined counterterrorism
          operations on both sides of the Pir Panjal range by formations of the
          Srinagar-based Chinar Corps and the Nagrota-headquartered White Knight
          Corps carrying out simultaneous operations. The Jammu and Kashmir
          Police, Central Reserve Police Force, Special Operations Group, and
          intelligence agencies will work closely together to foil
          Pakistan&apos;s designs to revive terrorism in the region,
          particularly in Rajouri and Poonch.
        </p>
        <p>
          The operations are intended to be similar to Operation Sarpvinash in
          2003 which targeted terrorists in the same area south of the Pir
          Panjals. The Army Chief General Manoj Pande recently stated that
          terrorist activities had almost vanished there since 2003, but
          Pakistan is now trying to revive terrorism in the region again. He and
          the Northern Army Command held detailed discussions on ways to counter
          this new terrorist threat.
        </p>
        <p>
          The operations are being closely monitored by Army Headquarters and
          the Northern Command in Udhampur and were planned soon after Home
          Minister Amit Shah held a high-level security meeting with National
          Security Advisor Ajit Doval, the Army, intelligence agencies, and
          police officials. The Northern Army Commander Lt Gen Upendra Dwivedi
          has also held coordination meetings for joint action against
          terrorists.
        </p>
        <p>
          The Indian Army has started inducting more troops into Rajouri and
          Poonch and strengthening intelligence capabilities. The security
          forces are confident of local support to counter terrorism in the
          area. Even when terrorists provoked troops to fire on civilians at
          Krisna Ghati, the forces showed restraint knowing it could turn the
          population against them. Swift action against own officers and men
          involved in civilian deaths post the December 21 encounter has also
          helped maintain local goodwill.
        </p>
        <p>
          The operations are intended to deny any space for terrorism to revive
          in the region. In the last two decades, determined counterterrorism
          efforts have ensured a marked reduction in violence. However, Pakistan
          has continued to support cross-border terrorism to destabilize Jammu
          and Kashmir. Groups like Lashkar-e-Taiba and Jaish-e-Mohammed have
          training camps across the border. Terrorists are regularly sent across
          the Line of Control under cover fire from Pakistan Army posts. Local
          youth are radicalized and recruited too.
        </p>
        <p>
          The increase in infiltration attempts over the last year, arms and
          ammunition drops by drones, and recruitments indicate Pakistan&apos;s
          desperation to stoke terrorism especially after the removal of Jammu
          and Kashmir&apos;s special status. Islamabad wants to portray that the
          situation is not normalizing even three years after Article 370 was
          nullified. Also, fomenting trouble in border areas pins down Indian
          forces. With India-Pakistan tensions at a high after recent terrorist
          incidents, Pakistan would want to keep the border hot.
        </p>
        <p>
          Its efforts to revive terrorism south of Pir Panjals poses a double
          threat as it provides entry into both Jammu and Kashmir regions.
          Rajouri and Poonch are very close to the strategic Jammu-Srinagar
          National Highway that is the lifeline of the Kashmir valley. Any major
          attack here can have psychological and economic impact far beyond the
          local populace and suits Pakistan&apos;s disruptive agenda.
        </p>
        <p>
          That is why the Indian Army is launching coordinated counterterrorism
          operations across the Pir Panjals before terrorism takes root again.
          The aim is to completely eliminate terrorist presence in these areas.
          In 2003 too, relentless operations had broken the back of terrorism
          here. Though eliminating every terrorist is difficult given the
          terrain and porous border, the intent is to inflict unacceptable
          losses through unrelenting pressure. The counter-infiltration grid
          along the Line of Control is also being strengthened to prevent entry.
        </p>
        <p>
          For the operations to succeed, gaining the confidence of the local
          population is vital. Sympathetic locals provide information, logistics
          and recruits to sustain terrorism. Alienating civilians can undermine
          even the best-planned operations. The Indian Army has reached out to
          the people through meetings, campaigns and civic action programs.
          Steps have been taken to minimize inconvenience and safeguard human
          rights during operations. Conduct of units is being closely monitored
          to avoid collateral damage. Any excesses are promptly investigated and
          punished as seen in the recent action against erring personnel. These
          measures are helping foster goodwill and support.
        </p>
        <p>
          Operation Sarvashakti has commenced in early 2022 at a time when heavy
          snow limits infiltrations. Come summer, as passes open, more
          terrorists will try to infiltrate. The Indian Army aims to use this
          winter to hit terror groups hard before the summer infiltration
          season. With meticulous preparation, transparency, sensitivity and
          determined execution, these operations can deal a decisive blow. The
          Indian Army remains steadfast in its commitment to break the back of
          Pakistan-sponsored terrorism and usher in an era of peace and
          stability for the people of Jammu and Kashmir.
        </p>
      </div>
    ),
  },
  {
    id: "u-s-sends-secret-message-to-iran-regarding-houthi-attacks-in-the-red-sea-says-president-joe-biden",
    timestamp: "Jan 14, 2024",
    image:
      "/jan-14-2024/u-s-sends-secret-message-to-iran-regarding-houthi-attacks-in-the-red-sea-says-president-joe-biden.jpg",
    title: `U.S. Sends Secret Message to Iran Regarding Houthi Attacks in the Red Sea, Says President Joe Biden`,
    preArticle: `President Joe Biden revealed that the United States had privately
          conveyed a message to Iran regarding the Iran-backed Houthi rebels
          carrying out attacks on commercial shipping vessels in the Red Sea.
          "We delivered it privately and we're confident we're well-prepared,"
          Biden told reporters at the White House before leaving for Camp David
          for the weekend.`,
    article: (
      <div className="space-y-6">
        <p>
          President Joe Biden revealed that the United States had privately
          conveyed a message to Iran regarding the Iran-backed Houthi rebels
          carrying out attacks on commercial shipping vessels in the Red Sea.
          &quot;We delivered it privately and we&apos;re confident we&apos;re
          well-prepared,&quot; Biden told reporters at the White House before
          leaving for Camp David for the weekend.
        </p>
        <p>
          The disclosure comes after the Houthi movement threatened a
          &quot;strong and effective response&quot; following an overnight U.S.
          military strike in Yemen, further increasing tensions as Washington
          vows to protect shipping from assaults by the Iran-aligned group.
        </p>
        <p>
          The latest U.S. strike, which the Pentagon said targeted Houthi radar
          facilities, occurred a day after dozens of American and British
          strikes on other Houthi sites in Yemen. According to White House
          spokesperson John Kirby, the initial strikes degraded the
          Houthis&apos; capability to store, launch and guide missiles or drones
          which they have frequently used to threaten shipping lanes. Kirby
          emphasized that Washington had no interest in waging war in Yemen.
        </p>
        <p>
          When asked by journalists whether he now felt the term
          &quot;terrorist&quot; was applicable to the Houthi rebels, Biden
          replied &quot;I think they are.&quot; This comes after the Biden
          administration controversially revoked the State Department&apos;s
          designation of the Houthis as a &quot;foreign terrorist
          organization&quot; in 2021, part of a policy shift aiming to ease
          humanitarian crisis in Yemen.
        </p>
        <p>
          The U.S. message to Iran highlights Washington&apos;s belief that
          Tehran bears responsibility for the Houthis&apos; aggressive actions
          as their chief international sponsor and arms supplier. While both
          Iran and the Houthis deny any formal relationship, UN experts have
          found extensive evidence of Iranian weapons transfers and other
          support.
        </p>
        <p>
          Proxy groups like the Houthis give Iran strategic leverage in the
          region while allowing it to maintain deniability for their actions.
          U.S. officials hope conveying their awareness of Iranian ties may
          induce Tehran to reign in the Houthis before the situation escalates
          further.
        </p>
        <p>
          However, experts warn the private U.S. message is unlikely to persuade
          Iran to pull back support and curb Houthi attacks on shipping in the
          Red Sea, a crucial commercial waterway. The Houthis have become
          increasingly brazen, using drones and missiles to target vessels
          sailing to and from the Suez Canal. Millions of barrels of oil pass
          through the area daily.
        </p>
        <p>
          While the Houthis say they are retaliating for coalition airstrikes
          and a sea blockade, their attacks are seen as part of a broader
          Iranian strategy to project power and demonstrate the vulnerability of
          global energy supply chains. Disrupting shipping could also drive up
          oil prices which benefits Tehran.
        </p>
        <p>
          The U.S. is coordinating closely with Gulf allies like Saudi Arabia
          and the UAE who are battling the Houthis in Yemen. But American
          officials are wary of being dragged into Yemen&apos;s complex civil
          war. The limited strikes specifically targeted Houthi capabilities to
          threaten shipping and avoid civilian areas. But analysts caution that
          direct U.S. intervention could empower the Houthis and aid their
          recruitment.
        </p>
        <p>
          With no clear military solution in Yemen, experts argue the only way
          forward is a negotiated settlement between the Houthis and
          Saudi-backed Yemeni government. But meaningful talks have stalled
          despite international efforts. The Houthis may prefer to keep fighting
          amid perceived battlefield gains while the Saudis remain skeptical of
          their intentions.
        </p>
        <p>
          In the meantime, the uptick in Houthi attacks has turned the Red Sea
          into an arena for shadowy attacks and counterstrikes. The U.S. message
          to Iran reflects the seriousness with which it views the threat to
          international shipping. While seeking to avoid further escalation,
          Washington also wants to signal its resolve to protect freedom of
          navigation and safeguard a vital global trade artery.
        </p>
      </div>
    ),
  },
  {
    id: "during-housing-crisis-canada-proposes-limit-on-international-student-enrollment",
    timestamp: "Jan 14, 2024",
    image:
      "/jan-14-2024/during-housing-crisis-canada-proposes-limit-on-international-student-enrollment.jpg",
    title: `During Housing Crisis, Canada Proposes Limit on International Student Enrollment`,
    preArticle: `Amid rising unemployment and a housing crisis in Canada, Immigration
          Minister Marc Miller announced that in the coming months he will
          examine capping the number of international students residing in the
          country. Miller did not specify the extent of the reduction being
          considered in the immigration system.`,
    article: (
      <div className="space-y-6">
        <p>
          Amid rising unemployment and a housing crisis in Canada, Immigration
          Minister Marc Miller announced that in the coming months he will
          examine capping the number of international students residing in the
          country. Miller did not specify the extent of the reduction being
          considered in the immigration system.
        ...
        <p>
          In an interview with Vassy Kapelos on CTV&apos;s Question Period,
          Miller stated a federal-provincial discussion is needed &quot;to
          ensure provinces not doing their jobs actually rein in student numbers
          purely on a volume basis.&quot; He said the volume of international
          students in Canada is &quot;disconcerting&quot; and the system has
          &quot;gotten out of control.&quot;
        </p>
        <p>
          Miller plans to explore setting a cap on international students in the
          first half of 2023 to help ease housing demand. When asked why the
          government is only now considering a cap despite the idea being raised
          months ago, he said federal level data is needed first before
          examining each province&apos;s institutions that may be profiting from
          high enrollment.
        </p>
        <p>
          &quot;It&apos;s time to have a conversation about volumes and the
          impact that is having in certain areas,&quot; Miller added. A student
          cap would not be a one-size-fits-all solution for housing shortages
          nationwide, he noted.
        </p>
        <p>
          Miller also said housing is only one factor in immigration targets.
          The pressing need to lower the workforce&apos;s average age must also
          be considered. While not providing specifics, he said reducing student
          numbers through a cap is under consideration and will remain so. Out
          of courtesy to the provinces, these discussions will occur at the
          negotiating table first, Miller stated, also factoring in
          institutions&apos; financial needs.
        </p>
        <p>
          The government has faced criticism for accepting rising immigrants,
          both permanent and temporary, amid a housing crisis. Internal
          documents show public servants warned two years ago that high
          immigration goals could threaten affordability.
        </p>
        <p>
          The Liberals aim to welcome 485,000 immigrants this year, and 500,000
          in 2025 and 2026. Hundreds of thousands of temporary residents like
          international students and migrant workers also arrive annually.
        </p>
        <p>
          A student cap would aim to curb demand, but risks detrimental impacts
          on institutions reliant on their tuition. Canada is a top global study
          destination and international students provide economic benefits. A
          balanced approach is needed to manage volumes without disrupting
          education and migration systems.
        </p>
        <p>
          Provinces like Ontario which attract nearly 40% of Canada&apos;s
          international students could be disproportionately affected by a
          blanket cap. A tailored province-wise approach may be more prudent.
          Students also create jobs and growth, so local labor market needs must
          be analyzed before reducing numbers.
        </p>
        <p>
          Capping student visas also does not address the root cause of housing
          unaffordability - insufficient supply. A cap could even worsen
          shortages if students continue arriving while fewer homes get built.
          Alongside any immigration changes, experts stress boosting housing
          supply by updating zoning laws and slashing red tape.
        </p>
        <p>
          Stakeholder views are important too before enacting a cap.
          Institutions warn blunt cuts could cripple revenue and impact
          learning. Students fear upending their future plans. A nuanced
          solution like needs-based entry could be explored.
        </p>
        <p>
          Alternatives like rent controls, vacant home taxes and boosting
          on-campus housing should be considered as well. A student cap risks
          damaging Canada’s reputation as a welcoming study destination.
          Partnerships with universities to align enrollment and housing
          capacity better could be fruitful.
        </p>
        <p>
          Ultimately, a balanced approach is required that stabilizes
          immigration at sustainable levels while rapidly expanding housing
          supply, especially affordable units. Canada’s future growth and
          competitiveness hinges on getting this policy mix right. A student cap
          may be one temporary tool, but broader structural solutions around
          housing and immigration are imperative for lasting impact.
        </p>
      </div>
    ),
  },
  {
    id: "yoga-guru-ramdev-clarifies-said-owaisi-not-obc-amidst-controversy-over-viral-video",
    timestamp: "Jan 14, 2024",
    image:
      "/jan-14-2024/yoga-guru-ramdev-clarifies-said-owaisi-not-obc-amidst-controversy-over-viral-video.jpg",
    title: `Yoga Guru Ramdev Clarifies "Said Owaisi, Not OBC", Amidst Controversy Over Viral Video`,
    preArticle: `Yoga guru Ramdev became embroiled in controversy following a viral
          video where he appeared to make remarks about the Other Backward
          Classes (OBC) community. However, Mr. Ramdev has since come forward to
          clarify that his comments were aimed at AIMIM leader Asaduddin Owaisi
          and were not intended to insult the OBC community.`,
    article: (
      <div className="space-y-6">
        <p>
          Yoga guru Ramdev became embroiled in controversy following a viral
          video where he appeared to make remarks about the Other Backward
          Classes (OBC) community. However, Mr. Ramdev has since come forward to
          clarify that his comments were aimed at AIMIM leader Asaduddin Owaisi
          and were not intended to insult the OBC community.
        ...
        <p>
          The widely circulated video sparked outrage on social media as it
          suggested Ramdev had denigrated the OBC community by asserting his
          Brahmin lineage. Responding to media queries, Ramdev insisted his
          statement was misconstrued and misheard.
        </p>
        <div>
          <blockquote className="twitter-tweet">
            <p lang="en" dir="ltr">
              VIDEO | &quot;I said &#39;Owaisi&#39; and not &#39;OBC&#39;,&quot;
              says Ramdev in response to a media query whether he had made any
              remarks on &#39;OBC&#39;.{" "}
              <a href="https://t.co/oTyDOLTXQI">pic.twitter.com/oTyDOLTXQI</a>
            </p>
            &mdash; Press Trust of India (@PTI_News){" "}
            <a href="https://twitter.com/PTI_News/status/1746095534274928871?ref_src=twsrc%5Etfw">
              January 13, 2024
            </a>
          </blockquote>{" "}
          <script async src="https://platform.twitter.com/widgets.js" />
        ...
        <p>
          While NDTV could not independently verify the video in question, it
          allegedly shows Ramdev proclaiming his Brahmin identity and listing
          various Brahmin gotras including &quot;Agnihotri Brahmin.&quot;
        </p>
        <p>
          The yoga guru explained, &quot;My original gotra is Brahma gotra. I am
          an Agnihotri Brahman. People say babaji is OBC...I am a Vedi Brahmin,
          Dwivedi Brahmin, Trivedi Brahmin, Chaturvedi Brahmin – I have read
          four Vedas.&quot;
        </p>
        <p>
          After the video went viral, many on social media protested using
          &apos;#boycottpatanjali&apos; and criticized Ramdev for his purported
          insult to the backward classes.
        </p>
        <p>
          Ramdev has reiterated that he did not intend to degrade any community.
          His statement was in response to Owaisi&apos;s remark insinuating
          Ramdev&apos;s non-Brahmin origins. Ramdev maintains he was simply
          clarifying his lineage and the context was misconstrued. He insists he
          has always spoken against caste discrimination and worked to uplift
          backward communities through his initiatives. The yoga guru hopes this
          controversy does not overshadow his lifelong efforts to promote
          equality.
        </p>
      </div>
    ),
  ...
  {
    id: "narayana-murthys-job-application-to-wipro-rejected-by-azim-premji-according-to-report",
    timestamp: "Jan 14, 2024",
    image:
      "/jan-14-2024/narayana-murthys-job-application-to-wipro-rejected-by-azim-premji-according-to-report.avif",
    title: `Narayana Murthy's Job Application to Wipro Rejected by Azim Premji, According to Report`,
    preArticle: `Infosys founder N.R. Narayana Murthy recently revealed in a CNBC-TV18
          interview that he had once applied for a job at Wipro but was
          rejected, leading to the genesis of Infosys, one of Wipro's fiercest
          competitors in the IT industry. Wipro's former chairman Azim Premji
          later admitted to Murthy that not hiring him was a mistake.`,
    article: (
      <div className="space-y-6">
        <p>
          Infosys founder N.R. Narayana Murthy recently revealed in a CNBC-TV18
          interview that he had once applied for a job at Wipro but was
          rejected, leading to the genesis of Infosys, one of Wipro&apos;s
          fiercest competitors in the IT industry. Wipro&apos;s former chairman
          Azim Premji later admitted to Murthy that not hiring him was a
          mistake.
        </p>
        <p>
          &quot;Azim once told me that one of the biggest mistakes he made was
          not hiring me,&quot; the 77-year-old Murthy said. He added that if
          Premji had hired him, things may have transpired differently for both
          him and Wipro.
        </p>
        <p>
          In 1981, Murthy founded Infosys along with six friends and 10,000
          rupees of seed capital provided by his wife and author Sudha Murty.
        </p>
        <p>
          While Murthy built Infosys from the ground up, Premji transformed his
          family&apos;s vegetable oil business into a global IT solutions
          provider. As of January 2024, Infosys is valued at 6.65 lakh crore
          rupees while Wipro stands at 2.43 lakh crore, exemplifying the
          divergent fortunes of the two IT titans.
        </p>
        <p>
          Murthy&apos;s entrepreneurial journey began with a research job at IIM
          Ahmedabad followed by a stint as chief systems programmer developing
          India&apos;s first BASIC interpreter for an early computer. After a
          failed prior tech venture called Softronics, the seeds of Infosys were
          sown.
        </p>
        <p>
          Murthy&apos;s perspective on family businesses differs markedly from
          Premji&apos;s approach. While Premji&apos;s son Rishad took over the
          reins at Wipro in 2019, Murthy asserts his son Rohan would never ask
          to be part of Infosys. &quot;I think he&apos;s even stricter than me
          on these ideas; he will never say that,&quot; Murthy stated.
        </p>
        <p>
          Decades ago, Murthy similarly rejected his wife Sudha Murty&apos;s
          wish to join Infosys, a decision he now regrets. Murthy admitted he
          was wrongly idealistic in not supporting Sudha, an engineer he says
          was more qualified than Infosys&apos; founders.
        </p>
        <p>
          Murthy has espoused keeping family and business separate, wanting
          Infosys to be a meritocratic workplace not influenced by nepotism. He
          credits Infosys&apos; success to its world-class governance and
          management entirely unrelated to the founders&apos; families.
        </p>
        <p>
          Infosys&apos; credo of empowering professionals on merit dissuaded
          Murthy&apos;s children from seeing Infosys as their entitlement.
          Murthy takes pride that his daughter is a schoolteacher and son is an
          academic uninterested in Infosys. He believes family businesses often
          struggle when incompetent heirs ascend due to privilege rather than
          capability.
        </p>
        <p>
          Premji&apos;s grooming of Rishad since 2007 to lead Wipro evokes the
          old-world family business model where bloodline trumps merit.
          Murthy&apos;s point is underscored by the middling performance of many
          Indian family conglomerates. Infosys&apos; rise as a global success
          story built on transparent governance and talent shows an alternative
          path.
        </p>
        <p>
          However, Premji&apos;s well-planned generational transition has so far
          been smooth. Rishad&apos;s track record includes leading Wipro&apos;s
          strategy and M&A for years before assuming the CEO role. Good
          succession planning has allowed the $11 billion company to continue
          its growth trajectory.
        </p>
        <p>
          Experts say neither approach is necessarily right or wrong. Premji has
          ensured continuity and stability by elevating his son. Murthy has
          upheld fairness and achievement by excluding his children. There are
          merits and demerits to both philosophies.
        </p>
        <p>
          Ultimately, what matters is identifying and empowering the right
          leaders to take an organization forward. Wipro and Infosys exemplify
          how different leadership models can thrive. Their unique approaches
          shaped by the personal values of their pioneering founders offer
          important lessons for Indian business.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    timestamp: "Jan 13, 2024",
    image:
      "/jan-13-2024/washing-machines-installed-in-overcrowded-prisons-for-inmate-skin-disease-prevention.avif",
    title: `Washing Machines Installed in Overcrowded Prisons for Inmate Skin Disease Prevention`,
    preArticle: `The extreme overcrowding in Maharashtra's state prisons has led to a rise in skin diseases among inmates. To address this issue, the Maharashtra prison department has introduced washing machines in jails for the first time.`,
    article: (
      <div className="space-y-6">
        <p>
          The extreme overcrowding in Maharashtra&apos;s state prisons has led
          to a rise in skin diseases among inmates. To address this issue, the
          Maharashtra prison department has introduced washing machines in jails
          for the first time.
        </p>
        <p>
          The Yerwada Central Prison in Pune has become the first jail in the
          state to provide washing machines for inmates. So far, all jails have
          placed orders for 193 washing machines in total.
        </p>
        <p>
          On an experimental basis, nine washing machines were installed in
          Yerwada Central Prison last Friday. Prison officials said they would
          study the impact of using washing machines and based on the results,
          considering the needs, install up to 325 washing machines in all jails
          in the near future.
        </p>
        <div className="space-y-1.5">
          <span className="text-xl">Overcrowding Fuels Health Issues</span>
          <div className="space-y-3">
            <p>
              Yerwada Prison has an official capacity of 2,753 inmates (2,536
              males, 226 females). But currently, there are 6,610 inmates -
              6,324 males and 286 females. Of these, 5,572 inmates are under
              judicial custody, 972 are convicts, and 66 are detained under the
              Maharashtra Prevention of Dangerous Activities Act.
            </p>
            <p>
              Prison authorities said jails across the state face similar
              overcrowding. While overcrowding contributes to the rise in skin
              diseases, disinfecting inmates&apos; clothes and bedding through
              proper washing is essential for prevention, officials said.
            </p>
            <p>
              The introduction of washing machines follows the example of New
              Delhi&apos;s Tihar Jail. Maharashtra&apos;s prison department is
              taking a cue from there, said Amitabh Gupta, Additional Director
              General of Police (Prisons).
            </p>
            <p>
              While the exact number of inmates with skin diseases was
              unavailable, Gupta said it was very high, with long queues at the
              doctor for skin treatment.
            </p>
          </div>
        </div>
        <div className="space-y-1.5">
          <span className="text-xl">Additional Facilities Introduced</span>
          <div className="space-y-3">
            <p>
              In addition to washing machines, Yerwada Prison inaugurated
              biometric touch screen e-kiosks on Friday. Using the e-kiosks,
              inmates can quickly access information on their case status,
              account balance, hearing dates, and more. Inmates can also have
              online meetings with lawyers and family through the e-mulakat
              application.
            </p>
          </div>
        </div>
        <div className="space-y-1.5">
          <span className="text-xl">Overcrowding Increases Unrest</span>
          <div className="space-y-3">
            <p>
              Officials said overcrowding increases chances of unrest in jails.
              Last month, a murder occurred inside Yerwada jail. There are about
              1,200 inmates in Yerwada booked under the Maharashtra Control of
              Organised Crime Act. Jail superintendents have been instructed to
              segregate members of rival gangs and those accused of terrorism,
              naxalism, etc. More CCTV cameras are being installed in 14
              prisons. A panic button system is also proposed to alert officials
              about incidents quickly.
            </p>
          </div>
        </div>
        <div className="space-y-1.5">
          <span className="text-xl">Plans to Address Overcrowding</span>
          <div className="space-y-3">
            <p>
              The prison department plans to construct new jails in several
              cities and recruit 2,000 more staff. Currently, with about 5,200
              staff for 40,000 inmates, the department is understaffed,
              especially constables. Of the inmates, about 8,000 are convicts.
              The additional staff and infrastructure will help address the
  ...
  {
    id: "indore-mayor-urges-ram-temple-replicas-in-every-shop-with-a-warning",
    timestamp: "Jan 13, 2024",
    image:
      "/jan-13-2024/indore-mayor-urges-ram-temple-replicas-in-every-shop-with-a-warning.jpg",
    title: `Indore Mayor Urges Ram Temple Replicas in Every Shop with a Warning`,
    preArticle: `Pushyamitra Bhargava left his successful legal career to become the mayor of Indore in 2022, promising to bring corporate culture to the municipal corporation. Recently, he has drawn attention for directing all malls and shops in Indore to install replicas of the Ram Temple in Ayodhya. He warned of consequences for those who fail to comply.`,
    article: (
      <div className="space-y-6">
        <p>
          Pushyamitra Bhargava left his successful legal career to become the
          mayor of Indore in 2022, promising to bring corporate culture to the
          municipal corporation. Recently, he has drawn attention for directing
          all malls and shops in Indore to install replicas of the Ram Temple in
          Ayodhya. He warned of consequences for those who fail to comply.
        </p>
        <p>
          Two weeks ago, Bhargava wrote to all shopkeepers and malls,
          instructing them to install the replicas between January 15-22,
          coinciding with the temple&apos;s consecration anniversary.
        </p>
        <p>
          On Monday, he justified the order, stating that if Christmas decor is
          allowed from December 25 to January 2, then Ram Temple replicas should
          also be permitted.
        </p>
        <p>
          Before entering politics, Bhargava was the youngest additional
          advocate general of the Madhya Pradesh High Court. Born and raised in
          Indore, he has an M.Phil in Law from Devi Ahilya University, a cyber
          law diploma from Mumbai, and a journalism certificate from Allahabad
          University. During college, he was active in the ABVP, the BJP&apos;s
          student wing.
        </p>
        <p>
          Bhargava began his legal career under senior advocate Piyush Mathur, a
          former MP High Court judge. He rose to become the state&apos;s
          youngest deputy advocate general from 2015-2018. He represented the
          government in high-profile cases, including on medical oxygen supply
          during Covid, direct student union elections, and a web series
          allegedly insulting the army.
        </p>
        <p>
          In 2020, Bhargava organized events supporting the Citizenship
          Amendment Act. He also led a &quot;Lawyers for Modi&quot; campaign for
          the 2019 elections. Additionally, he formed a youth organization
          called Sanghmitra to connect youth with patriotism and national
          service.
        </p>
        <p>
          In the 2022 mayoral polls, Bhargava defeated his Congress opponent by
          a huge margin, becoming BJP&apos;s youngest Indore mayor. His Ram
          temple replica order has now sparked controversy.
        </p>
      </div>
    ),
  },
  {
    id: "ed-issues-fourth-summon-to-delhi-cm-arvind-kejriwal-in-excise-policy-case",
    timestamp: "Jan 13, 2024",
    image:
      "/jan-13-2024/ed-issues-fourth-summon-to-delhi-cm-arvind-kejriwal-in-excise-policy-case.avif",
    title: `ED Issues Fourth Summon to Delhi CM Arvind Kejriwal in Excise Policy Case`,
    preArticle: `Delhi Chief Minister Arvind Kejriwal has received his fourth summons from the Enforcement Directorate (ED) for questioning in the controversial Delhi excise policy case. The central agency has asked him to appear before it on January 18.`,
    article: (
      <div className="space-y-6">
        <p>
          Delhi Chief Minister Arvind Kejriwal has received his fourth summons
          from the Enforcement Directorate (ED) for questioning in the
          controversial Delhi excise policy case. The central agency has asked
          him to appear before it on January 18.
        </p>
        <p>
          However, Kejriwal is likely to be in Goa from January 18-20 to oversee
          his Aam Aadmi Party&apos;s election preparations there, posing a
          scheduling conflict.
        </p>
        <p>
          The Delhi CM has skipped ED questioning on three previous occasions,
          citing reasons like impending Rajya Sabha elections, Republic Day
          engagements as Chief Minister, and lack of response from the ED to his
          queries.
        </p>
        <p>
          In his latest communication to the ED Assistant Director, Kejriwal
          highlighted that the Election Commission has scheduled Rajya Sabha
          polls from Delhi on January 19. As national convener of AAP, which has
          fielded candidates, he is preoccupied with the nominations and
          campaign.
        </p>
        <p>
          Furthermore, as Delhi CM, Kejriwal wrote he is busy with Republic Day
          event planning and preparations.
        </p>
        <p>
          This was the third instance of Kejriwal questioning the rationale
          behind ED&apos;s summons via written response instead of physically
          appearing. He expressed concern that despite comprehensively
          responding and raising legal objections, the ED chose not to provide
          clarification.
        </p>
        <p>
          In previous letters, Kejriwal termed the summons as politically
          motivated and alleged they were issued to harass him. He asked the ED
          to specify if he is being summoned as a witness or suspect and in what
          capacity. But the ED did not respond.
        </p>
        <p>
          The agency wants to question Kejriwal in connection with alleged
          irregularities in Delhi&apos;s now-scrapped excise policy. It claims
          kickbacks and corruption took place when the policy was formulated and
          implemented during Kejriwal&apos;s tenure.
        </p>
        <p>
          The ED and CBI filed FIRs in the matter after Delhi LG Vinai Kumar
          Saxena recommended a probe. He alleged violations of rules and
          procedural lapses in the policy, which purportedly benefited private
          liquor dealers.
        </p>
        <p>
          Besides Deputy CM Manish Sisodia who handled the excise portfolio, the
          ED has questioned and arrested other AAP leaders and excise department
          officials. Sisodia has been questioned for over 30 hours so far.
        </p>
        <p>
          AAP has denied any wrongdoing and accused the BJP-led central
          government of a political witchhunt. Kejriwal earlier alleged he is
          being deliberately targeted to stop AAP&apos;s growing national
          footprint ahead of elections in various states.
        </p>
        <p>
          The ED summons have disrupted governance work, claimed AAP. However,
          the BJP retorted that if Kejriwal has done no wrong, he should not
          fear investigation agencies and cooperate.
        </p>
        <p>
          With Kejriwal unlikely to appear on January 18 given his engagements,
          it remains to be seen if the ED will relent or take a strong stand.
          The agency can ask a court to direct Kejriwal to join the probe.
        </p>
        <p>
          Some analysts argue ED&apos;s repeated summons are creating an
          impression that it is overzealous about questioning Kejriwal. They
          suggest the agency should discuss the concerns raised in his letters
          before issuing fresh summons.
        </p>
        <p>
          As AAP aims to make inroads in Gujarat and other states, the timing of
          the probe is being seen as intended to dent its prospects. The tussle
          between the Centre and Delhi government looks set to continue, with
          both sides standing firm on their positions.
        </p>
        <p>
          Kejriwal&apos;s non-appearance may provide more ammunition to BJP to
          allege he has something to hide. However, AAP is also likely to use it
          to claim victimization at the hands of the Centre.
        </p>
        <p>
          How the impasse will end remains uncertain. But the excise case has
          certainly introduced new political drama and tensions between
          Delhi&apos;s ruling party and the central government.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    timestamp: "Jan 12, 2024",
    image:
      "/jan-12-2024/massive-retaliatory-strike-against-iranian-backed-houthis-in-yemen-launched-by-us-and-british-militaries.jpg",
    title: `Massive Retaliatory Strike Against Iranian-backed Houthis in Yemen Launched by US and British Militaries`,
    preArticle: `The U.S. and British militaries bombed over a dozen sites used by
          Iran-backed Houthi rebels in Yemen on Thursday. The massive
          retaliatory strike utilized warship and submarine missiles alongside
          fighter jets to target air defenses, drone and missile storage, and
          launching locations, officials said.`,
    article: (
      <div className="space-y-6">
        <p>
          The U.S. and British militaries bombed over a dozen sites used by
          Iran-backed Houthi rebels in Yemen on Thursday. The massive
          retaliatory strike utilized warship and submarine missiles alongside
          fighter jets to target air defenses, drone and missile storage, and
          launching locations, officials said.
        ...
        <p>
          President Biden stated the strikes demonstrated the U.S. and allies
          &quot;will not tolerate&quot; the militant group&apos;s relentless
          attacks on the Red Sea. Biden said they only acted after attempts at
          diplomacy and careful consideration.
        </p>
        <p>
          The strikes directly responded to unprecedented Houthi attacks on
          international ships, including first-time use of anti-ship ballistic
          missiles, endangering personnel and trade, Biden explained. He added
          he will take further measures as needed to protect people and
          commerce.
        </p>
        <p>
          In Yemen&apos;s capital Sanaa, journalists heard four explosions early
          Friday local time. Residents in the port city of Hodeida said they
          heard five strong blasts. Witnesses also reported strikes in cities
          south of Sanaa.
        </p>
        <p>
          The coordinated assault marked the first U.S. military response to the
          Houthis&apos; persistent attacks on commercial vessels since the
          Israel-Hamas war began. It came just a week after the U.S. and
          partners warned the Houthis to stop or risk potential military action.
          The warning briefly deterred attacks before the rebels&apos;
          largest-ever drone and missile barrage on shipping Tuesday, prompting
          U.S. and British ships to shoot down missiles.
        </p>
        <p>
          Officials said after Tuesday&apos;s attacks, Biden met with advisors
          and directed the retaliatory strikes. The UK confirmed its Royal Air
          Force took part, with fighters from Cyprus. Allied nations joined the
          U.S. and UK in saying they won&apos;t hesitate to defend lives and
          commerce, though the aim is de-escalation.
        </p>
        <p>
          The Houthis vowed retaliation, warning any attack will spark a fierce
          response beyond imagination. Houthi-run media described strikes
          hitting bases, airports and camps. Casualties remain unclear.
          Officials don&apos;t expect the strikes will eliminate Houthi
          capabilities but may prompt retaliation.
        </p>
        <p>
          The Houthis say their attacks aim to stop Israel&apos;s war in Gaza.
          But their targets increasingly have little connection to Israel while
          imperiling a crucial Asia-Europe trade route. The UN Security Council
          passed a resolution Wednesday demanding the Houthis immediately halt
          attacks and implicitly condemned their Iranian weapons suppliers.
        </p>
        <p>
          The broad coalition battling the Houthis shows the Biden
          administration&apos;s effort to avoid appearing unilateral. Multiple
          ships have already been struck despite a U.S.-led maritime mission to
          protect shipping. The U.S. long declined to signal when patience would
          run out before Wednesday&apos;s warning of consequences.
        </p>
        <p>
          The reluctance reflected sensitivities about the shaky Yemen truce and
          worries about triggering wider regional conflict. But the
          attacks&apos; impact on shipping and escalation triggered the
          coalition warning. The strikes underscored using a united front rather
          than opening a new war front alone.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    timestamp: "Jan 12, 2024",
    image:
      "/jan-12-2024/decision-by-grand-jury-ohio-woman-escapes-corpse-abuse-charges-after-home-miscarriage.webp",
    title: `Decision by Grand Jury: Ohio Woman Escapes Corpse Abuse Charges After Home Miscarriage`,
    preArticle: `An Ohio woman who was criminally charged for allegedly mishandling a
          home miscarriage will not be indicted, a grand jury decided on
          Thursday.`,
    article: (
      <div className="space-y-6">
        <p>
          An Ohio woman who was criminally charged for allegedly mishandling a
          home miscarriage will not be indicted, a grand jury decided on
          Thursday.
        </p>
        <p>
          The prosecutor&apos;s office in Trumbull County said the grand jury
          declined to charge Brittany Watts, 34, of Warren with abuse of a
          corpse. This resolved a controversial case that drew national
          attention for its implications for pregnant women as states enact new
          laws on reproductive healthcare access post - Roe v. Wade.
        </p>
        <p>
          The decision came just before around 150 supporters gathered for a
          rally supporting Watts in Warren&apos;s Courthouse Square. Watts
          addressed the crowd, thanking her community and declaring she will
          continue fighting.
        </p>
        <p>
          Watts&apos; attorney said an outpouring of public support helped her
          client endure being charged with a felony. The lawyer stated that
          despite how upsetting it sounds, Watts&apos; experience reflects the
          sad reality of miscarriage. They expressed relief and gratitude that
          the grand jury reached a just decision today.
        </p>
        <p>
          A municipal judge previously found probable cause against Watts.
          Prosecutors alleged she miscarried into a toilet, removed contents to
          outdoor trash, and left the 22-week fetus lodged in pipes. Records
          show her doctor advised hospital induction due to nonviable pregnancy
          and serious risks. But complications and delays prevented treatment.
          After miscarrying at home, she unsuccessfully tried going to a hair
          appointment before friends insisted she go to the hospital. A
          nurse&apos;s 911 call spurred the ensuing investigation.
        </p>
        <p>
          The prosecutor argued the issue was not how or when the fetus died,
          but that Watts discarded it in the toilet, clogging it, and went about
          her day. An autopsy found the fetus died in utero with no recent
          injuries. Watts&apos; lawyer contended she had no criminal record and
          was being vilified for a common occurrence. The lawyer also questioned
          whether the abuse-of-corpse statute clearly defined terms like
          &quot;corpse&quot; and &quot;outrage&quot;.
        </p>
        <p>
          After binding the case over, the judge acknowledged better scholars
          should determine the fetus&apos;s precise legal status. Now, the
          prosecutor says further investigation found Watts committed no crime,
          despite disagreeing with the lower court&apos;s law application.
        </p>
        <p>
          Advocates expressed relief at the outcome, but warned Watts&apos; case
          exemplifies the threats Black women face for pregnancy outcomes amid
          abortion restrictions. They called for ending the criminalization of
          reproductive outcomes, which undermines rights and deters necessary
          care. Watts hopes her experience prompts change through education and
          legislation so no other woman endures similar trauma fighting for
          freedom.
        </p>
      </div>
    ),
  ...
  {
    id: "love-and-betrayal-shoaib-sheikh-accused-of-bank-manager-amit-kaurs-killing",
    timestamp: "Jan 12, 2024",
    image:
      "/jan-12-2024/love-and-betrayal-shoaib-sheikh-accused-of-bank-manager-amit-kaurs-killing.webp",
    title: `Love and Betrayal: Shoaib Sheikh Accused of Bank Manager Amit Kaur's Killing`,
    preArticle: `In a tragic example of a failed romantic relationship, a man in Mumbai
          killed his partner. Three months ago, the pair connected on social
          media. The incident happened in Navi Mumbai's Turbhe. The crime
          blurred the lines between revenge and love when a 24-year-old man
          named Shoaib Sheikh planned the 35-year-old bank manager Amit Kaur—a
          divorcee and mother of a teenage girl was killed.`,
    article: (
      <div className="space-y-6">
        <p>
          In a tragic example of a failed romantic relationship, a man in Mumbai
          killed his partner. Three months ago, the pair connected on social
          media. The incident happened in Navi Mumbai&apos;s Turbhe. The crime
          blurred the lines between revenge and love when a 24-year-old man
          named Shoaib Sheikh planned the 35-year-old bank manager Amit Kaur—a
        ...
        <p>
          The story started a few months ago, when Shoaib and Amit connected on
          social media. When Shoaib arrived in Turbhe on January 8th to
          celebrate Kaur&apos;s birthday, what appeared to be a blossoming
          romance took a dark turn.
        </p>
        <p>
          Based on the details given by the police, it appears that Shoaib
          killed Amit Kaur by strangulation in a lodge where they were
          celebrating, driven by feelings of suspicion and grief. Shoaib left
          the scene after carrying out the horrific deed, leaving the staff to
          discover the woman&apos;s lifeless body when they opened the door.
        </p>
        <p>
          Shoaib Sheikh was taken into custody by the Sakinaka police in Mumbai
          after they carried out an investigation. After being arrested, the
          young man—who worked in a garage—finally admitted to the crime.
        </p>
        <p>
          According to the police, Shoaib&apos;s misgivings about his lover
          ultimately motivated him to commit the murder. The victim, a
          well-liked bank manager, had no idea what evil plans had been
          simmering inside of Shoaib.
        </p>
        <p>
          The tragic event clarified the effects of a relationship poisoned by
          suspicion and deceit. The community was left reeling from the shocking
          reality that had descended upon them as the legal proceedings
          progressed and the dark secrets underlying this bizarre story of love
          and betrayal continued to come to light.
        </p>
      </div>
    ),
  },
  {
    id: "air-india-passenger-shocked-to-find-chicken-in-vegetarian-meal-on-board",
    timestamp: "Jan 12, 2024",
    image:
      "/jan-12-2024/air-india-passenger-shocked-to-find-chicken-in-vegetarian-meal-on-board.webp",
    title: `Air India Passenger Shocked to Find Chicken in Vegetarian Meal on Board`,
    preArticle: `When the vegetarian food offered to a woman traveling from Calicut to
          Mumbai on an Air India flight discovered pieces of chicken in it, she
          was taken aback.`,
    article: (
      <div className="space-y-6">
        <p>
          When the vegetarian food offered to a woman traveling from Calicut to
          Mumbai on an Air India flight discovered pieces of chicken in it, she
          was taken aback.
        </p>
        <p>
          Later, Veera Jain shared the entire tale on X, a platform that was
          formerly Twitter. She also posted pictures of the food served to her
          by the airline.
        </p>
        <p>
          “On my @airindia flight AI582, I was served a veg meal with chicken
          pieces in it! I boarded the flight from Calicut airport. This was a
          flight that was supposed to take off at 18:40PM but left the airport
          at 19:40PM,” Veera Jain wrote.
        </p>
        <div>
          <blockquote className="twitter-tweet">
            <p lang="en" dir="ltr">
              On my{" "}
              <a href="https://twitter.com/airindia?ref_src=twsrc%5Etfw">
                @airindia
              </a>{" "}
              flight AI582, I was served a veg meal with chicken pieces in it! I
              boarded the flight from Calicut airport. This was a flight that
              was supposed to take off at 18:40PM but left the airport at
              19:40PM.
              <br />
              Details-
              <br />
              ...
              <br />
              Seats- 10E, 10F
              <a href="https://twitter.com/hashtag/AirIndia?src=hash&amp;ref_src=twsrc%5Etfw">
                #AirIndia
              </a>{" "}
              <a href="https://t.co/LlyK6ywleB">pic.twitter.com/LlyK6ywleB</a>
            </p>
            &mdash; Veera Jain (@VeeraJain){" "}
            <a href="https://twitter.com/VeeraJain/status/1744611763377913931?ref_src=twsrc%5Etfw">
              January 9, 2024
            </a>
          </blockquote>{" "}
          <script async src="https://platform.twitter.com/widgets.js" />
        ...
        <p>
          The word &quot;Veg&quot; is clearly visible on the wrapper of her food
          packet in the pictures she posted, but the chicken pieces inside are
          also irresistible. The woman continued to tweet &quot;When I told the
          cabin supervisor (Sona), she apologized and told me that there were
          other complaints about the same issue besides mine and my
          friend&apos;s. But nothing was done to let other passengers know that
          other people were eating vegetarian meals after I told the crew.&quot;
        </p>
        <p>
          She went on to say that she felt hurt and that she no longer trusted
          Air India.
        </p>
        <p>
          Veera also appeared to be having trouble with the flight&apos;s
          takeoff delay. According to her, the AI582 flight was scheduled to
          depart at 6:40 p.m., but it was delayed by one hour. Her friend missed
          her train from Mumbai to Ahmedabad at 11 p.m. that night because of
          the delayed flight. At 8:40 p.m., the AI582 was supposed to touch down
          in Mumbai.
        </p>
        <p>
          Air India has not yet responded to this incident, so Jain urged the
          Ministry of Civil Aviation, the Indian Civil Aviation Authority
          (DGCA), and Civil Aviation Minister Jyotiraditya Scindia to look into
          the situation.
        </p>
      </div>
    ),
  ...
  // jan-08-2024
  {
    id: "bollywood-stars-ranbir-kapoor-and-alia-bhatt-receives-invitation-to-ram-mandir-opening-ceremony-to-be-held-on-january-22nd",
    timestamp: "Jan 08, 2024",
    image:
      "/jan-08-2024/bollywood-stars-ranbir-kapoor-and-alia-bhatt-receives-invitation-to-ram-mandir-opening-ceremony-to-be-held-on-january-22nd.jpg",
    title: `Bollywood Stars, Ranbir Kapoor and Alia Bhatt Receives Invitation to Ram Mandir Opening Ceremony to be held on January 22nd`,
    preArticle: `Bollywood actors Ranbir Kapoor and Alia Bhatt have received
          invitations to attend the Ram Mandir inauguration in Ayodhya on
          January 22, subsequent to Rajinikanth's invitation. The couple
          received an invitation in person from members of the Rashtriya
          Swayamsevak Sangh.`,
    article: (
      <div className="space-y-6">
        <p>
          Bollywood actors Ranbir Kapoor and Alia Bhatt have received
          invitations to attend the Ram Mandir inauguration in Ayodhya on
          January 22, subsequent to Rajinikanth&apos;s invitation. The couple
          received an invitation in person from members of the Rashtriya
          Swayamsevak Sangh.
        ...
        <p>
          On Sunday, Sunil Ambekar, the RSS&apos;s Akhil Bharatiya Prachar
          Pramukh, Ajay Mudpe, the RSS Konkan&apos;s Prant Prachar Pramukh, and
          producer Mahaveer Jain met with Ranbir Kapoor and his spouse Alia.
          They received flowers as a welcome and received an official invitation
          to the Ram Janmabhoomi Mandir Pran Pratistha ceremony.
        </p>
        <div className="relative w-full h-72 sm:h-96 bg-slate-200 rounded-xl overflow-hidden">
          <Image
            priority
            src="/jan-08-2024/bollywood-stars-ranbir-kapoor-and-alia-bhatt-receives-invitation-to-ram-mandir-opening-ceremony-to-be-held-on-january-22nd(2).jpg"
        ...
        <p>
          More than 100,000 devotees are expected to congregate in Ayodhya on
          January 22 for the Ram Mandir&apos;s &quot;pran pratishtha&quot;
          ceremony, according to the reports. It is planned for Prime Minister
          Narendra Modi to attend the function.
        </p>
        <p>
          The general secretary of Shri Ram Janmabhoomi Teerth Kshetra, Champat
          Rai, says that the Ram temple will have particular dimensions and be
          built in the traditional Nagara style. 161 feet in height, 250 feet in
          width, and 380 feet long from east to west. The temple will have
          twenty feet on each floor, three hundred and ninety-two pillars, and
          forty-four gates.
        </p>
        <p>
          Chief of the Shiv Sena, Uddhav Thackeray, announced that he would
          perform a Maha Aarti at the Godavari riverbank in Nashik on January
          22, which is the day the Ram temple in Ayodhya opens. He also plans to
          go to the Kalaram temple in Panchavati, which is thought to be the
          location of Lord Ram&apos;s stay during his banishment. Although
          Uddhav was not invited to the inauguration of the Ram temple, Shiv
          Sena and BJP leaders got into a verbal altercation over this.
        </p>
      </div>
    ),
  },
  {
    id: "india-maldives-ties-in-focus-social-media-sparks-dialogue-on-complex-bilateral-relations",
    timestamp: "Jan 08, 2024",
    image:
      "/jan-08-2024/india-maldives-ties-in-focus-social-media-sparks-dialogue-on-complex-bilateral-relations.jpg",
    title: `India-Maldives Ties in Focus: Social Media Sparks Dialogue on Complex Bilateral Relations`,
    preArticle: `Social media was rocked by Maldivian politicians' remarks about Indian
          Prime Minister Narendra Modi's visit to Lakshadweep, which revealed
          more about the two nations' relationship than just tourism.`,
    article: (
      <div className="space-y-6">
        <p>
          Social media was rocked by Maldivian politicians&apos; remarks about
          Indian Prime Minister Narendra Modi&apos;s visit to Lakshadweep, which
          revealed more about the two nations&apos; relationship than just
          tourism.
        </p>
        <p>
          Mohamed Muizzu, the recently elected president of the Maldives, has
          requested that India remove its troops from the island nation. The
          troops are in charge of three exquisite aircraft that are being used
          for patrol.
        </p>
        <p>
          What really infuriated Indians, though, were remarks made by
          politicians in the Maldives that were deemed racist. As a result, many
          Indians called for a boycott of travel to the Maldives.
        </p>
        <p>
          Numerous well-known people have expressed their support for
          Modi&apos;s expedition and encouraged tourists to visit Indian
          islands.
        </p>
        <div className="space-y-1.5">
          <span className="text-xl">
            Maldives tourism is dominated by India
          </span>
          <p>
            The tourism industry, which generates the majority of the
            country&apos;s foreign exchange earnings and government revenue, is
            a major contributor to the Maldivian economy. Due to its gorgeous
            beaches, opulent lodging options, and mouthwatering seafood, the
            island nation has become a popular travel destination in South Asia.
          </p>
        </div>
        <p>
          The Maldivian Tourism Ministry reports that 161,751 arrivals from
          India were registered in November 2023 alone, making up nearly 20% of
          all arrivals. In the meantime, Indians held the second position in
          market share from January to November 2023, accounting for 10.9
          percent of all arrivals, or 181, 371 arrivals, in the nation.
        </p>
        <p>
          India ranked as the fifth-largest country from which tourists arrived
          in the Maldives in 2018. Approximately 6.1% (more than 90,474) of the
          14,84,274 tourists came from India. Nevertheless, India ranked second
          in 2019 with 1,66,030 arrivals, nearly twice as many as the previous
          year. With almost 63,000 Indian tourists visiting the Maldives in the
          pandemic-hit year 2020, India accounted for the Maldives&apos; largest
          source market. With over 2.91 lakh and 2.41 lakh tourist arrivals from
          India, respectively, and a 23 percent and 14.4 percent market share,
          India remained the leading market in 2021 and 2022.
        </p>
        <div className="space-y-1.5">
          <span className="text-xl">
            Education, finance, and defense: India helps the Maldives
          </span>
          <p>
            India and the Maldives have collaborated closely in defense and
            security since 1988. Regarding meeting the Maldives&apos;
            requirements for defense hardware and training, India has been
            incredibly accommodating and adaptable. As of late, it has signed a
            comprehensive Action Plan for Defence in April 2016 and has
            continued to provide defense hardware, upgrade defense
            infrastructure, and train Maldivian forces.
          </p>
        </div>
        <p>
          Regarding financial support, the Maldives received an additional $100
          million in funding from the Modi administration in November 2022. The
          help came in the shape of budgetary support to help the archipelago
          nation get through its challenging economic times. It should be
          mentioned that the aid is being provided unconditionally, and the
          Maldives has been allowed to use it however it sees fit to aid in its
          economic recovery.
        </p>
        <p>
          India further solidified its reputation as the “first responder” when
          it quickly sent 30,000 doses of the measles vaccine to the Maldives in
          January 2020 to stop an outbreak. India also provided the Maldives
          with prompt, all-encompassing assistance during the COVID-19 pandemic.
        </p>
        <p>
          Every year, a number of young Maldivians attend Indian universities to
          pursue higher education. For many years, Maldivian schools located
          throughout the islands have employed Indian educators. Maldivian youth
          have historically been awarded a significant number of ICCR
          scholarships by India, specifically 39 for 2021-2022 and 34+ for
          2022-2023 & 2023-2024.
        </p>
        <div className="space-y-1.5">
          <span className="text-xl">Current controversy:</span>
          <p>
            Following PM Modi&apos;s visit, a number of prospective tourists
            canceled their plans due to remarks made by Zahid Rameez, a council
            member of the Progressive Party of the Maldives (PPM), that were
            disparaging and included a reference to a &quot;permanent smell in
            the rooms.&quot;
          </p>
        </div>
        <p>
          In a statement, the Maldives government promised to take the
          appropriate action against the individuals, stating that these
          opinions are personal and do not reflect the government&apos;s views.
        </p>
        <p>
          Many Indian travelers expressed their displeasure on social media and
          threatened to cancel their vacation plans to the Maldives in protest.
        </p>
      </div>
    ),
  },
  {
    id: "aot-attack-on-titan-english-dub-finale-release-date-and-streaming-platform-announced",
    timestamp: "Jan 08, 2024",
    image:
      "/jan-08-2024/aot-attack-on-titan-english-dub-finale-release-date-and-streaming-platform-announced.avif",
    title: `AOT (Attack on Titan) English Dub Finale: Release Date and Streaming Platform Announced`,
    preArticle: `The conclusion of "Attack on Titan" will bring an end to an era for
          one of the most acclaimed shonen anime series, after a protracted and
          much anticipated journey. The anime, which is based on the manga by
          Hajime Isayama, has become incredibly well-liked and respected for its
          depiction of people surviving in a post-apocalyptic world while facing
          enormous Titans. Fans are incredibly excited for the series finale as
          they get ready to say goodbye to beloved characters like Mikasa and
          Eren.`,
    article: (
      <div className="space-y-6">
        <p>
          The conclusion of &quot;Attack on Titan&quot; will bring an end to an
          era for one of the most acclaimed shonen anime series, after a
          protracted and much anticipated journey. The anime, which is based on
          the manga by Hajime Isayama, has become incredibly well-liked and
          respected for its depiction of people surviving in a post-apocalyptic
          world while facing enormous Titans. Fans are incredibly excited for
          the series finale as they get ready to say goodbye to beloved
          characters like Mikasa and Eren.
        </p>
        <p>
          &quot;Attack on Titan&quot; has taken viewers on a wild ride for
          almost ten years, covering unspeakable horrors and existential
          devastation in four seasons and eighty-eight episodes. With the finale
          fast approaching, fans can expect a satisfying conclusion to the
          ongoing conflict between the Survey Corps and the Titans. It&apos;s
          going to be an emotional rollercoaster.
        </p>
        <p>
          The last episode&apos;s release date and streaming information On
          January 7, 2024, the highly anticipated 89th and last episode of the
          English dub of &quot;Attack on Titan&quot; will premiere on
          Crunchyroll. In North America, Central America, South America, Europe,
          Africa, Oceania, the Middle East, the CIS, and Southeast Asia, the
          release is scheduled to occur at 9:00 p.m. PT. This represents the
          climax of an epic saga that aired on April 7, 2013, as fans get ready
          for the big reveal.
        </p>
        <div className="space-y-1.5">
          <span className="text-xl">Watch on Platforms:</span>
          <p>
            Adult Swim, Funimation, Hulu, and Crunchyroll Official English
            subtitles for the final episode and every previous episode can be
            found on Crunchyroll and Hulu. It will also be broadcast on Adult
            Swim and Funimation. Fans can relax knowing that the epic conclusion
            will be available on these well-known streaming services, even
            though the release date for the dubbed version on other platforms
            has not yet been announced.
          </p>
        </div>
        <div className="space-y-1.5">
          <span className="text-xl">An Overview of the Main Event:</span>
          <p>
            On November 3, 2023, the &quot;Attack on Titan Final Season Part
            4&quot; final trailer was released. The one-hour and
            twenty-six-minute special episode is teased in the trailer, despite
            it not being available in English. With MAPPA going all out to
            deliver the anticipated elements of the series—grotesque violence,
            excruciating pain, emotional depth, and philosophical insights into
            the nature of war and humanity—it promises an animated spectacle.
          </p>
        </div>
        <p>
          Concluding the Chapter with a Deeply Feeling Effect The series&apos;
          climactic trailer teases the last valiant moments of adored characters
          while hinting at significant manga sequences.
        </p>
        <div className="space-y-1.5">
          <span className="text-xl">
            What is Attack on Titan&apos;s primary plot?
          </span>
          <p>
            After witnessing the destruction of his hometown and suffering from
            trauma, young Eren Jaeger swears to eradicate the enormous humanoid
            Titans that are driving humanity towards extinction from Earth. The
            Titans are enormous creatures that almost wipe out humankind.
          </p>
        </div>
        <div className="space-y-1.5">
          <span className="text-xl">Attack of Titan is 18+; why is that?</span>
          <p>
            There is very little plot protection for characters in this violent
            series; people can die, be consumed, beaten, tortured, shot,
            crushed, and more. But since it&apos;s an animated program, the
            violence isn&apos;t depicted any more graphically than it would be
            in a show like Game of Thrones. Characters are occasionally seen
            smoking and drinking wine, but these scenes don&apos;t have a
            recurring theme.
          </p>
        </div>
      </div>
