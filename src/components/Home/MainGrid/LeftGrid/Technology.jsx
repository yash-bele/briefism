          ...
          {technology.slice(5, 7).map((i, j) => (
            ...
            >
              <Image
                ...
                fill
                sizes="auto"
                className="absolute w-full h-full block object-cover object-center group-hover:scale-110 duration-500"
              />
