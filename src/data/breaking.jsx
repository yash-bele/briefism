export const breaking = [
    ...
    article: (
      <>
        ...
        <p>
          ...
          according to the Japan Meteorological Agency (JMA), with one
          prefecture recording an initial magnitude of 7.6, as reported by The
          Associated Press. Following the earthquake, local weather agencies
          predicted that there would be tsunami waves within 300 kilometers of
          the Noto, Ishigawa, epicenter.
        </p>
        <p>
          At 4:06 PM local time, a 5.7 magnitude earthquake sparked the seismic
          activity. Subsequently, at 4:10 PM, a 7.6 magnitude earthquake, at
          4:18 PM, a 6.1 magnitude earthquake, at 4:23 PM local time, a 4.5
          magnitude event, at 4:29 PM local time, and at 4:32 PM local time, a
        ...
        <p>
          Many videos that have been going viral on social media show
          individuals being forced to shelter under tables and chairs as
          buildings tremble violently. Meanwhile powerful tsunami waves posed an
          immediate threat to coastal areas. The earthquake activity caused
          severe damage to surrounding roadways and fractures in them, resulting
          in the collapse of numerous dwellings.
        </p>
      </>
    ),
  },
    ...
    article: (
      <>
        ...
        <p>
          ...
          Union territories thus far. The Indian SARS-CoV-2 Genomics Consortium
          (INSACOG) lists these states as follows: Kerala (83), Goa (51),
          Gujarat (34), Karnataka (eight), Maharashtra (seven), Rajasthan
          (five), Tamil Nadu (four), Telangana (two), Odisha (one), and Delhi
          (one).
        </p>
        <p>
        ...
        <p>
          ...
          sub-variant in the nation, the Center has requested that the states
          and Union territories keep a continuous watch. India now has 636 new
  ...
  // 3
  {
    ...
    article: (
      <>
        <p>
          Gangster Goldy Brar, the mastermind behind the brutal murder of
          Punjabi singer Sidhu Moosewala, was on Monday declared a designated
          terrorist by the Centre under the Unlawful Activities (Prevention) Act
          (UAPA).
        </p>
        <p>
        ...
        <p>
          ...
          Bargari sacrilege case, Kataria was out on bail and was shot dead at
          his shop by a group of six men on November 11 that year. Brar is also
  ...
  // 4
  {
    ...
    article: (
      <>
        <p>
          After a 21-minute flight, the Indian Space Research Organization
          (ISRO) launched the X-ray Polarimeter Satellite (XPoSat), its first
          polarimetry mission, into an exact circular orbit of 650 km on Monday
          morning, January 1.
        </p>
        <p>
        ...
        <p>
          Over the course of its projected five-year mission, XPoSat will
  ...
  // 5
  {
    id: "ai-could-artificial-superpowers-to-life-by-2024-here's-how",
    timestamp: "Jan 03, 2024",
    image:
    ...
    article: (
      <>
        ...
        <p>
          ...
          on the knowledge that humans have accumulated over thousands of years.
          This is a technology that is all-pervasive and will soon become
          commonplace.
        </p>
        <p>
          ...
          everything related to them changed so swiftly that it is now
          challenging to predict our future.
        </p>
      </>
    ),
  },
  // 6
  {
    ...
    timestamp: "Jan 03, 2024",
    image:
      "/jan-03-2024/bihar-gang-made-men-offer-13-lakh-to-get-women-into-marriage-8-arrested.jpg",
    ...
    article: (
      <>
        ...
        <p>
          In Bihar, eight people have been taken into custody for allegedly
  ...
  // 7
  {
    ...
    timestamp: "Jan 03, 2024",
    image:
      "/jan-03-2024/3-people-shot-dead-in-the-valley-district-of-manipur-curfew-enforced.webp",
    ...
    article: (
      <>
        ...
        <p>
          ...
          arrived disguised as locals and started shooting. Hospitalized are
          five more injured individuals. A few cars were set on fire by angry
          locals following the attack. Three Manipur Police commandos were hurt
          on Saturday night, a few days prior, when an RPG attack occurred at
          one of their posts in the border town of Moreh. According to
          officials, suspected militants are thought to be responsible for the
          attack.
        </p>
        <p>
